...
ScalaJS.c.O.prototype.hashCode__I = (function() {
  return ScalaJS.m.jl_System$().identityHashCode__O__I(this)
});
ScalaJS.c.O.prototype.equals__O__Z = (function(that) {
  return (this === that)
});
ScalaJS.c.O.prototype.toString__T = (function() {
  return ((ScalaJS.objectGetClass(this).getName__T() + "@") + ScalaJS.m.jl_Integer$().toHexString__I__T(this.hashCode__I()))
});
...
ScalaJS.c.jl_Character$.prototype.valueOf__C__jl_Character = (function(charValue) {
  return new ScalaJS.c.jl_Character().init___C(charValue)
});
ScalaJS.c.jl_Character$.prototype.toString__C__T = (function(c) {
  return ScalaJS.as.T(ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["String"]["fromCharCode"](ScalaJS.m.sjs_js_Any$().fromInt__I__sjs_js_Any(c)))
});
...
ScalaJS.c.jl_Double$.prototype.valueOf__D__jl_Double = (function(doubleValue) {
  return doubleValue
});
...
ScalaJS.c.jl_Integer$.prototype.toStringBase__p1__I__I__T = (function(i, base) {
  return ScalaJS.as.T(ScalaJS.m.sjs_js_JSNumberOps$().enableJSNumberOps__D__sjs_js_JSNumberOps(ScalaJS.m.sjs_js_JSNumberOps$ExtOps$().toUint$extension__sjs_js_Dynamic__D(ScalaJS.m.sjs_js_JSNumberOps$().enableJSNumberExtOps__I__sjs_js_Dynamic(i)))["toString"](base))
});
...
ScalaJS.c.jl_Math$.prototype.floor__D__D = (function(a) {
  return ScalaJS.uD(ScalaJS.g["Math"]["floor"](a))
});
ScalaJS.c.jl_Math$.prototype.pow__D__D__D = (function(a, b) {
  return ScalaJS.uD(ScalaJS.g["Math"]["pow"](a, b))
});
ScalaJS.c.jl_Math$.prototype.log__D__D = (function(a) {
  return ScalaJS.uD(ScalaJS.g["Math"]["log"](a))
});
ScalaJS.is.jl_Math$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.jl_Math$)))
});
ScalaJS.as.jl_Math$ = (function(obj) {
  return ((ScalaJS.is.jl_Math$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "java.lang.Math$"))
});
...
ScalaJS.asArrayOf.jl_Math$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.jl_Math$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Ljava.lang.Math$;", depth))
});
...
ScalaJS.c.jl_System$.prototype.arraycopy__O__I__O__I__I__V = (function(src, srcPos, dest, destPos, length) {
  ...
  if (((src === null) || (dest === null))) {
    ...
    matchEnd12: {
      if (ScalaJS.isArrayOf.O(x1, 1)) {
        var x2 = ScalaJS.asArrayOf.O(x1, 1);
        var x1$2 = dest;
        if (ScalaJS.isArrayOf.O(x1$2, 1)) {
          var x2$2 = ScalaJS.asArrayOf.O(x1$2, 1);
      ...
      if (ScalaJS.isArrayOf.Z(x1, 1)) {
        var x3 = ScalaJS.asArrayOf.Z(x1, 1);
        var x1$3 = dest;
        if (ScalaJS.isArrayOf.Z(x1$3, 1)) {
          var x2$3 = ScalaJS.asArrayOf.Z(x1$3, 1);
      ...
      if (ScalaJS.isArrayOf.C(x1, 1)) {
        var x4 = ScalaJS.asArrayOf.C(x1, 1);
        var x1$4 = dest;
        if (ScalaJS.isArrayOf.C(x1$4, 1)) {
          var x2$4 = ScalaJS.asArrayOf.C(x1$4, 1);
      ...
      if (ScalaJS.isArrayOf.B(x1, 1)) {
        var x5 = ScalaJS.asArrayOf.B(x1, 1);
        var x1$5 = dest;
        if (ScalaJS.isArrayOf.B(x1$5, 1)) {
          var x2$5 = ScalaJS.asArrayOf.B(x1$5, 1);
      ...
      if (ScalaJS.isArrayOf.S(x1, 1)) {
        var x6 = ScalaJS.asArrayOf.S(x1, 1);
        var x1$6 = dest;
        if (ScalaJS.isArrayOf.S(x1$6, 1)) {
          var x2$6 = ScalaJS.asArrayOf.S(x1$6, 1);
      ...
      if (ScalaJS.isArrayOf.I(x1, 1)) {
        var x7 = ScalaJS.asArrayOf.I(x1, 1);
        var x1$7 = dest;
        if (ScalaJS.isArrayOf.I(x1$7, 1)) {
          var x2$7 = ScalaJS.asArrayOf.I(x1$7, 1);
      ...
      if (ScalaJS.isArrayOf.J(x1, 1)) {
        var x8 = ScalaJS.asArrayOf.J(x1, 1);
        var x1$8 = dest;
        if (ScalaJS.isArrayOf.J(x1$8, 1)) {
          var x2$8 = ScalaJS.asArrayOf.J(x1$8, 1);
      ...
      if (ScalaJS.isArrayOf.F(x1, 1)) {
        var x9 = ScalaJS.asArrayOf.F(x1, 1);
        var x1$9 = dest;
        if (ScalaJS.isArrayOf.F(x1$9, 1)) {
          var x2$9 = ScalaJS.asArrayOf.F(x1$9, 1);
      ...
      if (ScalaJS.isArrayOf.D(x1, 1)) {
        var x10 = ScalaJS.asArrayOf.D(x1, 1);
        var x1$10 = dest;
        if (ScalaJS.isArrayOf.D(x1$10, 1)) {
          var x2$10 = ScalaJS.asArrayOf.D(x1$10, 1);
...
ScalaJS.c.jl_System$.prototype.identityHashCode__O__I = (function(x) {
  ...
  matchEnd12: {
    ...
    var x$2 = (void 0);
    var x$3 = x1;
    if (((x$2 === null) ? (x$3 === null) : ScalaJS.objectEquals(x$2, x$3))) {
      var jsx$1 = true;
      break matchEnd12
    };
    var jsx$1 = false;
  ...
  if ((ScalaJS.objectGetClass(x) === null)) {
    return 42
  } else {
    var hash = x["$idHashCode$0"];
    if ((!ScalaJS.m.sjs_js_package$().isUndefined__O__Z(hash))) {
      return ScalaJS.uI(hash)
    } else {
      var newHash = ScalaJS.m.jl_System$IDHashCode$().nextIDHashCode__I();
      x["$idHashCode$0"] = ScalaJS.m.sjs_js_Any$().fromInt__I__sjs_js_Any(newHash);
      return newHash
    }
  }
});
ScalaJS.c.jl_System$.prototype.$$anonfun$1__p1__D = (function() {
  return ScalaJS.uD(ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["performance"]["now"]())
});
ScalaJS.c.jl_System$.prototype.$$anonfun$2__p1__D = (function() {
  return ScalaJS.uD(ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["performance"]["webkitNow"]())
});
...
ScalaJS.c.jl_System$.prototype.checkIndices$1__p1__I__I__I__I__I__V = (function(srcLen, destLen, srcPos$1, destPos$1, length$1) {
  if ((((((srcPos$1 < 0) || (destPos$1 < 0)) || (length$1 < 0)) || (((srcPos$1 + length$1) | 0) > srcLen)) || (((destPos$1 + length$1) | 0) > destLen))) {
    throw new ScalaJS.c.jl_ArrayIndexOutOfBoundsException().init___T("Array index out of bounds")
  }
});
ScalaJS.c.jl_System$.prototype.mismatch$1__p1__sr_Nothing$ = (function() {
  throw new ScalaJS.c.jl_ArrayStoreException().init___T("Incompatible array types")
});
ScalaJS.c.jl_System$.prototype.copyPrim$mZc$sp$1__p1__AZ__AZ__I__I__I__Z__V = (function(src, dest, srcPos$1, destPos$1, length$1, forward$1) {
...
ScalaJS.c.jl_System$.prototype.copyPrim$mBc$sp$1__p1__AB__AB__I__I__I__Z__V = (function(src, dest, srcPos$1, destPos$1, length$1, forward$1) {
  this.checkIndices$1__p1__I__I__I__I__I__V(src.u["length"], dest.u["length"], srcPos$1, destPos$1, length$1);
  if (forward$1) {
    var i = 0;
    while ((i < length$1)) {
...
ScalaJS.c.jl_System$.prototype.copyPrim$mCc$sp$1__p1__AC__AC__I__I__I__Z__V = (function(src, dest, srcPos$1, destPos$1, length$1, forward$1) {
  this.checkIndices$1__p1__I__I__I__I__I__V(src.u["length"], dest.u["length"], srcPos$1, destPos$1, length$1);
  if (forward$1) {
    var i = 0;
    while ((i < length$1)) {
...
ScalaJS.c.jl_System$.prototype.copyPrim$mDc$sp$1__p1__AD__AD__I__I__I__Z__V = (function(src, dest, srcPos$1, destPos$1, length$1, forward$1) {
  this.checkIndices$1__p1__I__I__I__I__I__V(src.u["length"], dest.u["length"], srcPos$1, destPos$1, length$1);
  if (forward$1) {
    var i = 0;
    while ((i < length$1)) {
...
ScalaJS.c.jl_System$.prototype.copyPrim$mFc$sp$1__p1__AF__AF__I__I__I__Z__V = (function(src, dest, srcPos$1, destPos$1, length$1, forward$1) {
  this.checkIndices$1__p1__I__I__I__I__I__V(src.u["length"], dest.u["length"], srcPos$1, destPos$1, length$1);
  if (forward$1) {
    var i = 0;
    while ((i < length$1)) {
...
ScalaJS.c.jl_System$.prototype.copyPrim$mIc$sp$1__p1__AI__AI__I__I__I__Z__V = (function(src, dest, srcPos$1, destPos$1, length$1, forward$1) {
  this.checkIndices$1__p1__I__I__I__I__I__V(src.u["length"], dest.u["length"], srcPos$1, destPos$1, length$1);
  if (forward$1) {
    var i = 0;
    while ((i < length$1)) {
...
ScalaJS.c.jl_System$.prototype.copyPrim$mJc$sp$1__p1__AJ__AJ__I__I__I__Z__V = (function(src, dest, srcPos$1, destPos$1, length$1, forward$1) {
  this.checkIndices$1__p1__I__I__I__I__I__V(src.u["length"], dest.u["length"], srcPos$1, destPos$1, length$1);
  if (forward$1) {
    var i = 0;
    while ((i < length$1)) {
...
ScalaJS.c.jl_System$.prototype.copyPrim$mSc$sp$1__p1__AS__AS__I__I__I__Z__V = (function(src, dest, srcPos$1, destPos$1, length$1, forward$1) {
  this.checkIndices$1__p1__I__I__I__I__I__V(src.u["length"], dest.u["length"], srcPos$1, destPos$1, length$1);
  if (forward$1) {
    var i = 0;
    while ((i < length$1)) {
...
ScalaJS.c.jl_System$.prototype.copyRef$1__p1__AO__AO__I__I__I__Z__V = (function(src, dest, srcPos$1, destPos$1, length$1, forward$1) {
  this.checkIndices$1__p1__I__I__I__I__I__V(src.u["length"], dest.u["length"], srcPos$1, destPos$1, length$1);
  if (forward$1) {
    var i = 0;
    while ((i < length$1)) {
...
ScalaJS.c.jl_System$.prototype.init___ = (function() {
  ...
  this.out$1 = new ScalaJS.c.jl_JSConsoleBasedPrintStream().init___jl_Boolean(ScalaJS.m.s_Predef$().boolean2Boolean__Z__jl_Boolean(false));
  this.err$1 = new ScalaJS.c.jl_JSConsoleBasedPrintStream().init___jl_Boolean(ScalaJS.m.s_Predef$().boolean2Boolean__Z__jl_Boolean(true));
  this.in$1 = null;
  this.getHighPrecisionTime$1 = (ScalaJS.m.sjs_js_DynamicImplicits$().truthValue__sjs_js_Dynamic__Z(ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["performance"]) ? (ScalaJS.m.sjs_js_DynamicImplicits$().truthValue__sjs_js_Dynamic__Z(ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["performance"]["now"]) ? (function(this$2) {
    return (function() {
      return this$2.$$anonfun$1__p1__D()
    })
  })(this) : (ScalaJS.m.sjs_js_DynamicImplicits$().truthValue__sjs_js_Dynamic__Z(ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["performance"]["webkitNow"]) ? (function(this$3) {
    return (function() {
      return this$3.$$anonfun$2__p1__D()
    })
  })(this) : (function(this$4) {
    return (function() {
      return this$4.$$anonfun$3__p1__D()
    })
  })(this))) : (function(this$5) {
    return (function() {
      return this$5.$$anonfun$4__p1__D()
    })
  })(this));
  return this
});
...
/** @constructor */
ScalaJS.c.jl_System$IDHashCode$ = (function() {
  ScalaJS.c.O.call(this);
  this.lastIDHashCode$1 = 0
});
ScalaJS.c.jl_System$IDHashCode$.prototype = new ScalaJS.h.O();
ScalaJS.c.jl_System$IDHashCode$.prototype.constructor = ScalaJS.c.jl_System$IDHashCode$;
/** @constructor */
ScalaJS.h.jl_System$IDHashCode$ = (function() {
  /*<skip>*/
});
ScalaJS.h.jl_System$IDHashCode$.prototype = ScalaJS.c.jl_System$IDHashCode$.prototype;
ScalaJS.c.jl_System$IDHashCode$.prototype.lastIDHashCode__p1__I = (function() {
  return this.lastIDHashCode$1
});
ScalaJS.c.jl_System$IDHashCode$.prototype.lastIDHashCode$und$eq__p1__I__V = (function(x$1) {
  this.lastIDHashCode$1 = x$1
});
ScalaJS.c.jl_System$IDHashCode$.prototype.nextIDHashCode__I = (function() {
  var r = ((this.lastIDHashCode__p1__I() + 1) | 0);
  this.lastIDHashCode$und$eq__p1__I__V(r);
  return r
});
ScalaJS.c.jl_System$IDHashCode$.prototype.init___ = (function() {
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.n.jl_System$IDHashCode$ = this;
  this.lastIDHashCode$1 = 0;
  return this
});
ScalaJS.is.jl_System$IDHashCode$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.jl_System$IDHashCode$)))
});
ScalaJS.as.jl_System$IDHashCode$ = (function(obj) {
  return ((ScalaJS.is.jl_System$IDHashCode$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "java.lang.System$IDHashCode$"))
});
ScalaJS.isArrayOf.jl_System$IDHashCode$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.jl_System$IDHashCode$)))
});
ScalaJS.asArrayOf.jl_System$IDHashCode$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.jl_System$IDHashCode$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Ljava.lang.System$IDHashCode$;", depth))
});
ScalaJS.d.jl_System$IDHashCode$ = new ScalaJS.ClassTypeData({
  jl_System$IDHashCode$: 0
}, false, "java.lang.System$IDHashCode$", ScalaJS.d.O, {
  jl_System$IDHashCode$: 1,
  O: 1
});
ScalaJS.c.jl_System$IDHashCode$.prototype.$classData = ScalaJS.d.jl_System$IDHashCode$;
ScalaJS.n.jl_System$IDHashCode$ = (void 0);
ScalaJS.m.jl_System$IDHashCode$ = (function() {
  if ((!ScalaJS.n.jl_System$IDHashCode$)) {
    ScalaJS.n.jl_System$IDHashCode$ = new ScalaJS.c.jl_System$IDHashCode$().init___()
  };
  return ScalaJS.n.jl_System$IDHashCode$
});
/** @constructor */
...
ScalaJS.c.jl_ThreadLocal.prototype.hasValue__p1__jl_Boolean = (function() {
  return this.hasValue$1
});
ScalaJS.c.jl_ThreadLocal.prototype.hasValue$und$eq__p1__jl_Boolean__V = (function(x$1) {
  this.hasValue$1 = x$1
});
...
ScalaJS.c.jl_ThreadLocal.prototype.get__O = (function() {
  if ((!ScalaJS.m.s_Predef$().Boolean2boolean__jl_Boolean__Z(this.hasValue__p1__jl_Boolean()))) {
...
ScalaJS.c.jl_ThreadLocal.prototype.set__O__V = (function(o) {
  ...
  this.hasValue$und$eq__p1__jl_Boolean__V(ScalaJS.m.s_Predef$().boolean2Boolean__Z__jl_Boolean(true))
});
ScalaJS.c.jl_ThreadLocal.prototype.init___ = (function() {
  ScalaJS.c.O.prototype.init___.call(this);
  this.hasValue$1 = ScalaJS.m.s_Predef$().boolean2Boolean__Z__jl_Boolean(false);
  return this
});
...
ScalaJS.s.s_DeprecatedPredef$class__$$init$__s_Predef$__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.s_Function0$class__toString__F0__T = (function($$this) {
  return "<function0>"
});
ScalaJS.s.s_Function0$class__$$init$__F0__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.s_Function1$class__toString__F1__T = (function($$this) {
  return "<function1>"
});
ScalaJS.s.s_Function1$class__$$init$__F1__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
...
ScalaJS.s.s_PartialFunction$class__$$init$__s_PartialFunction__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.s_Product$class__$$init$__s_Product__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.s_Product2$class__productArity__s_Product2__I = (function($$this) {
  return 2
});
...
ScalaJS.s.s_Product2$class__$$init$__s_Product2__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.s_Product3$class__productArity__s_Product3__I = (function($$this) {
  return 3
});
...
ScalaJS.s.s_Product3$class__$$init$__s_Product3__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.s_Product5$class__productArity__s_Product5__I = (function($$this) {
  return 5
});
ScalaJS.s.s_Product5$class__productElement__s_Product5__I__O = (function($$this, n) {
  var x1 = n;
  switch (x1) {
    case 0:
      {
...
ScalaJS.s.s_Product5$class__$$init$__s_Product5__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
...
ScalaJS.c.s_compat_Platform$.prototype.arraycopy__O__I__O__I__I__V = (function(src, srcPos, dest, destPos, length) {
  ScalaJS.m.jl_System$().arraycopy__O__I__O__I__I__V(src, srcPos, dest, destPos, length)
});
...
ScalaJS.as.s_compat_Platform$ = (function(obj) {
  return ((ScalaJS.is.s_compat_Platform$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.compat.Platform$"))
});
...
ScalaJS.asArrayOf.s_compat_Platform$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.s_compat_Platform$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.compat.Platform$;", depth))
});
...
ScalaJS.n.s_compat_Platform$ = (void 0);
...
ScalaJS.s.s_io_AnsiColor$class__$$init$__s_io_AnsiColor__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.s_math_LowPriorityEquiv$class__$$init$__s_math_Equiv$__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.s_math_LowPriorityOrderingImplicits$class__$$init$__s_math_LowPriorityOrderingImplicits__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
...
ScalaJS.s.s_math_Ordered$class__$$init$__s_math_Ordered__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
...
ScalaJS.as.s_math_package$ = (function(obj) {
  return ((ScalaJS.is.s_math_package$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.math.package$"))
});
...
ScalaJS.asArrayOf.s_math_package$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.s_math_package$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.math.package$;", depth))
});
...
ScalaJS.n.s_math_package$ = (void 0);
...
ScalaJS.s.s_reflect_ClassManifestDeprecatedApis$class__$$init$__s_reflect_ClassTag__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
...
ScalaJS.s.s_reflect_ClassTag$class__$$init$__s_reflect_ClassTag__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.s_reflect_Manifest$class__$$init$__s_reflect_Manifest__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
...
ScalaJS.s.s_util_control_NoStackTrace$class__fillInStackTrace__s_util_control_NoStackTrace__jl_Throwable = (function($$this) {
  return (ScalaJS.m.s_util_control_NoStackTrace$().noSuppression__Z() ? $$this.scala$util$control$NoStackTrace$$super$fillInStackTrace__jl_Throwable() : ScalaJS.as.jl_Throwable($$this))
});
ScalaJS.s.s_util_control_NoStackTrace$class__$$init$__s_util_control_NoStackTrace__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
...
ScalaJS.c.s_util_hashing_MurmurHash3.prototype.orderedHash__sc_TraversableOnce__I__I = (function(xs, seed) {
  ...
  xs.foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2, n, h) {
    return (function(x$2) {
      var x = x$2;
      this$2.$$anonfun$2__p1__O__sr_IntRef__sr_IntRef__V(x, n, h)
    })
  })(this, n, h)));
...
ScalaJS.s.sc_BufferedIterator$class__$$init$__sc_BufferedIterator__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_CustomParallelizable$class__$$init$__sc_CustomParallelizable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_GenIterable$class__$$init$__sc_GenIterable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_GenSeq$class__$$init$__sc_GenSeq__V = (function($$this) {
  /*<skip>*/
});
...
ScalaJS.s.sc_GenSeqLike$class__$$init$__sc_GenSeqLike__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_GenTraversable$class__$$init$__sc_GenTraversable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_IndexedSeq$class__$$init$__sc_IndexedSeq__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_IndexedSeqLike$class__hashCode__sc_IndexedSeqLike__I = (function($$this) {
  return ScalaJS.m.s_util_hashing_MurmurHash3$().seqHash__sc_Seq__I($$this.seq__sc_IndexedSeq())
});
ScalaJS.s.sc_IndexedSeqLike$class__iterator__sc_IndexedSeqLike__sc_Iterator = (function($$this) {
  return new ScalaJS.c.sc_IndexedSeqLike$Elements().init___sc_IndexedSeqLike__I__I($$this, 0, $$this.length__I())
});
ScalaJS.s.sc_IndexedSeqLike$class__$$init$__sc_IndexedSeqLike__V = (function($$this) {
  /*<skip>*/
});
...
ScalaJS.s.sc_IndexedSeqOptimized$class__$$init$__sc_IndexedSeqOptimized__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_Iterable$class__$$init$__sc_Iterable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_IterableLike$class__foreach__sc_IterableLike__F1__V = (function($$this, f) {
...
ScalaJS.s.sc_IterableLike$class__canEqual__sc_IterableLike__O__Z = (function($$this, that) {
  return true
});
ScalaJS.s.sc_IterableLike$class__$$init$__sc_IterableLike__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
...
ScalaJS.s.sc_Iterator$class__$$init$__sc_Iterator__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_LinearSeq$class__$$init$__sc_LinearSeq__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_LinearSeqLike$class__hashCode__sc_LinearSeqLike__I = (function($$this) {
  return ScalaJS.m.s_util_hashing_MurmurHash3$().seqHash__sc_Seq__I($$this.seq__sc_LinearSeq())
});
ScalaJS.s.sc_LinearSeqLike$class__iterator__sc_LinearSeqLike__sc_Iterator = (function($$this) {
  return new ScalaJS.c.sc_LinearSeqLike$$anon$1().init___sc_LinearSeqLike($$this)
});
ScalaJS.s.sc_LinearSeqLike$class__$$init$__sc_LinearSeqLike__V = (function($$this) {
  /*<skip>*/
});
...
ScalaJS.s.sc_LinearSeqOptimized$class__$$init$__sc_LinearSeqOptimized__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_Parallelizable$class__$$init$__sc_Parallelizable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_Seq$class__$$init$__sc_Seq__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_SeqLike$class__isEmpty__sc_SeqLike__Z = (function($$this) {
  return ($$this.lengthCompare__I__I(0) === 0)
});
ScalaJS.s.sc_SeqLike$class__toString__sc_SeqLike__T = (function($$this) {
  return ScalaJS.s.sc_TraversableLike$class__toString__sc_TraversableLike__T($$this)
});
ScalaJS.s.sc_SeqLike$class__$$init$__sc_SeqLike__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_Traversable$class__$$init$__sc_Traversable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sc_TraversableLike$class__repr__sc_TraversableLike__O = (function($$this) {
  return $$this
});
...
ScalaJS.s.sc_TraversableLike$class__stringPrefix__sc_TraversableLike__T = (function($$this) {
  ...
  if ((idx1 !== (-1))) {
    string = ScalaJS.m.sjsr_RuntimeString$().substring__T__I__T(string, ((idx1 + 1) | 0))
  };
  var idx2 = ScalaJS.m.sjsr_RuntimeString$().indexOf__T__I__I(string, 36);
  if ((idx2 !== (-1))) {
    string = ScalaJS.m.sjsr_RuntimeString$().substring__T__I__I__T(string, 0, idx2)
  };
  return string
});
ScalaJS.s.sc_TraversableLike$class__$$init$__sc_TraversableLike__V = (function($$this) {
  /*<skip>*/
});
...
ScalaJS.s.sc_TraversableOnce$class__addString__sc_TraversableOnce__scm_StringBuilder__T__T__T__scm_StringBuilder = (function($$this, b, start, sep, end) {
  ...
  $$this.foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function($$this, first, b, sep) {
    return (function(x$2) {
      var x = x$2;
      return ScalaJS.s.sc_TraversableOnce$class__$$anonfun$16__p0__sc_TraversableOnce__O__sr_BooleanRef__scm_StringBuilder__T__O($$this, x, first, b, sep)
    })
  })($$this, first, b, sep)));
  b.append__T__scm_StringBuilder(end);
  return b
});
ScalaJS.s.sc_TraversableOnce$class__$$anonfun$16__p0__sc_TraversableOnce__O__sr_BooleanRef__scm_StringBuilder__T__O = (function($$this, x, first$4, b$2, sep$1) {
  if (first$4.elem$1) {
...
ScalaJS.s.sc_TraversableOnce$class__$$init$__sc_TraversableOnce__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
...
ScalaJS.s.scg_GenericTraversableTemplate$class__$$init$__scg_GenericTraversableTemplate__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scg_Growable$class__$$init$__scg_Growable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scg_Shrinkable$class__$$init$__scg_Shrinkable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scg_Subtractable$class__$$init$__scg_Subtractable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sci_IndexedSeq$class__seq__sci_IndexedSeq__sci_IndexedSeq = (function($$this) {
  return $$this
});
ScalaJS.s.sci_IndexedSeq$class__$$init$__sci_IndexedSeq__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sci_Iterable$class__$$init$__sci_Iterable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sci_LinearSeq$class__seq__sci_LinearSeq__sci_LinearSeq = (function($$this) {
  return $$this
});
ScalaJS.s.sci_LinearSeq$class__$$init$__sci_LinearSeq__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sci_Seq$class__$$init$__sci_Seq__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
...
ScalaJS.s.sci_StringLike$class__$$init$__sci_StringLike__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sci_Traversable$class__$$init$__sci_Traversable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.sci_VectorPointer$class__initFrom__sci_VectorPointer__sci_VectorPointer__V = (function($$this, that) {
...
ScalaJS.s.sci_VectorPointer$class__$$init$__sci_VectorPointer__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scm_ArrayLike$class__$$init$__scm_ArrayLike__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scm_Buffer$class__$$init$__scm_Buffer__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scm_BufferLike$class__$$init$__scm_Buffer__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scm_Builder$class__$$init$__scm_Builder__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scm_Cloneable$class__$$init$__scm_Cloneable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scm_IndexedSeq$class__seq__scm_IndexedSeq__scm_IndexedSeq = (function($$this) {
  return $$this
});
ScalaJS.s.scm_IndexedSeq$class__$$init$__scm_IndexedSeq__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scm_IndexedSeqLike$class__$$init$__scm_IndexedSeqLike__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scm_Iterable$class__$$init$__scm_Iterable__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scm_Seq$class__$$init$__scm_Seq__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scm_SeqLike$class__$$init$__scm_SeqLike__V = (function($$this) {
  /*<skip>*/
});
ScalaJS.s.scm_Traversable$class__$$init$__scm_Traversable__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
ScalaJS.c.sjs_js_Dynamic$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.sjs_js_Dynamic$.prototype = new ScalaJS.h.O();
ScalaJS.c.sjs_js_Dynamic$.prototype.constructor = ScalaJS.c.sjs_js_Dynamic$;
/** @constructor */
ScalaJS.h.sjs_js_Dynamic$ = (function() {
  /*<skip>*/
});
ScalaJS.h.sjs_js_Dynamic$.prototype = ScalaJS.c.sjs_js_Dynamic$.prototype;
ScalaJS.c.sjs_js_Dynamic$.prototype.global__sjs_js_Dynamic = (function() {
  return ScalaJS.g
});
ScalaJS.is.sjs_js_Dynamic$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sjs_js_Dynamic$)))
});
ScalaJS.as.sjs_js_Dynamic$ = (function(obj) {
  return ((ScalaJS.is.sjs_js_Dynamic$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.scalajs.js.Dynamic$"))
});
ScalaJS.isArrayOf.sjs_js_Dynamic$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.sjs_js_Dynamic$)))
});
ScalaJS.asArrayOf.sjs_js_Dynamic$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.sjs_js_Dynamic$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.scalajs.js.Dynamic$;", depth))
});
ScalaJS.d.sjs_js_Dynamic$ = new ScalaJS.ClassTypeData({
  sjs_js_Dynamic$: 0
}, false, "scala.scalajs.js.Dynamic$", ScalaJS.d.O, {
  sjs_js_Dynamic$: 1,
  O: 1
});
ScalaJS.c.sjs_js_Dynamic$.prototype.$classData = ScalaJS.d.sjs_js_Dynamic$;
ScalaJS.n.sjs_js_Dynamic$ = (void 0);
ScalaJS.m.sjs_js_Dynamic$ = (function() {
  if ((!ScalaJS.n.sjs_js_Dynamic$)) {
    ScalaJS.n.sjs_js_Dynamic$ = new ScalaJS.c.sjs_js_Dynamic$().init___()
  };
  return ScalaJS.n.sjs_js_Dynamic$
});
/** @constructor */
ScalaJS.c.sjs_js_DynamicImplicits$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.sjs_js_DynamicImplicits$.prototype = new ScalaJS.h.O();
ScalaJS.c.sjs_js_DynamicImplicits$.prototype.constructor = ScalaJS.c.sjs_js_DynamicImplicits$;
/** @constructor */
ScalaJS.h.sjs_js_DynamicImplicits$ = (function() {
  /*<skip>*/
});
ScalaJS.h.sjs_js_DynamicImplicits$.prototype = ScalaJS.c.sjs_js_DynamicImplicits$.prototype;
ScalaJS.c.sjs_js_DynamicImplicits$.prototype.truthValue__sjs_js_Dynamic__Z = (function(x) {
  return ScalaJS.uZ((!(!x)))
});
ScalaJS.is.sjs_js_DynamicImplicits$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sjs_js_DynamicImplicits$)))
});
ScalaJS.as.sjs_js_DynamicImplicits$ = (function(obj) {
  return ((ScalaJS.is.sjs_js_DynamicImplicits$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.scalajs.js.DynamicImplicits$"))
});
ScalaJS.isArrayOf.sjs_js_DynamicImplicits$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.sjs_js_DynamicImplicits$)))
});
ScalaJS.asArrayOf.sjs_js_DynamicImplicits$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.sjs_js_DynamicImplicits$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.scalajs.js.DynamicImplicits$;", depth))
});
ScalaJS.d.sjs_js_DynamicImplicits$ = new ScalaJS.ClassTypeData({
  sjs_js_DynamicImplicits$: 0
}, false, "scala.scalajs.js.DynamicImplicits$", ScalaJS.d.O, {
  sjs_js_DynamicImplicits$: 1,
  O: 1
});
ScalaJS.c.sjs_js_DynamicImplicits$.prototype.$classData = ScalaJS.d.sjs_js_DynamicImplicits$;
ScalaJS.n.sjs_js_DynamicImplicits$ = (void 0);
ScalaJS.m.sjs_js_DynamicImplicits$ = (function() {
  if ((!ScalaJS.n.sjs_js_DynamicImplicits$)) {
    ScalaJS.n.sjs_js_DynamicImplicits$ = new ScalaJS.c.sjs_js_DynamicImplicits$().init___()
  };
  return ScalaJS.n.sjs_js_DynamicImplicits$
});
ScalaJS.s.sjs_js_JSApp$class__$$js$exported$meth$main__sjs_js_JSApp__O = (function($$this) {
  $$this.main__V()
});
ScalaJS.s.sjs_js_JSApp$class__$$init$__sjs_js_JSApp__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
ScalaJS.c.sjs_js_JSNumberOps$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.sjs_js_JSNumberOps$.prototype = new ScalaJS.h.O();
ScalaJS.c.sjs_js_JSNumberOps$.prototype.constructor = ScalaJS.c.sjs_js_JSNumberOps$;
/** @constructor */
ScalaJS.h.sjs_js_JSNumberOps$ = (function() {
  /*<skip>*/
});
ScalaJS.h.sjs_js_JSNumberOps$.prototype = ScalaJS.c.sjs_js_JSNumberOps$.prototype;
ScalaJS.c.sjs_js_JSNumberOps$.prototype.enableJSNumberOps__D__sjs_js_JSNumberOps = (function(x) {
  return x
});
ScalaJS.c.sjs_js_JSNumberOps$.prototype.enableJSNumberExtOps__I__sjs_js_Dynamic = (function(x) {
  return x
});
ScalaJS.is.sjs_js_JSNumberOps$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sjs_js_JSNumberOps$)))
});
ScalaJS.as.sjs_js_JSNumberOps$ = (function(obj) {
  return ((ScalaJS.is.sjs_js_JSNumberOps$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.scalajs.js.JSNumberOps$"))
});
ScalaJS.isArrayOf.sjs_js_JSNumberOps$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.sjs_js_JSNumberOps$)))
});
ScalaJS.asArrayOf.sjs_js_JSNumberOps$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.sjs_js_JSNumberOps$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.scalajs.js.JSNumberOps$;", depth))
});
ScalaJS.d.sjs_js_JSNumberOps$ = new ScalaJS.ClassTypeData({
  sjs_js_JSNumberOps$: 0
}, false, "scala.scalajs.js.JSNumberOps$", ScalaJS.d.O, {
  sjs_js_JSNumberOps$: 1,
  O: 1
});
ScalaJS.c.sjs_js_JSNumberOps$.prototype.$classData = ScalaJS.d.sjs_js_JSNumberOps$;
ScalaJS.n.sjs_js_JSNumberOps$ = (void 0);
ScalaJS.m.sjs_js_JSNumberOps$ = (function() {
  if ((!ScalaJS.n.sjs_js_JSNumberOps$)) {
    ScalaJS.n.sjs_js_JSNumberOps$ = new ScalaJS.c.sjs_js_JSNumberOps$().init___()
  };
  return ScalaJS.n.sjs_js_JSNumberOps$
});
/** @constructor */
ScalaJS.c.sjs_js_JSNumberOps$ExtOps$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.sjs_js_JSNumberOps$ExtOps$.prototype = new ScalaJS.h.O();
ScalaJS.c.sjs_js_JSNumberOps$ExtOps$.prototype.constructor = ScalaJS.c.sjs_js_JSNumberOps$ExtOps$;
/** @constructor */
ScalaJS.h.sjs_js_JSNumberOps$ExtOps$ = (function() {
  /*<skip>*/
});
ScalaJS.h.sjs_js_JSNumberOps$ExtOps$.prototype = ScalaJS.c.sjs_js_JSNumberOps$ExtOps$.prototype;
ScalaJS.c.sjs_js_JSNumberOps$ExtOps$.prototype.toUint$extension__sjs_js_Dynamic__D = (function($$this) {
  return ScalaJS.uD(($$this >>> 0))
});
ScalaJS.is.sjs_js_JSNumberOps$ExtOps$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sjs_js_JSNumberOps$ExtOps$)))
});
ScalaJS.as.sjs_js_JSNumberOps$ExtOps$ = (function(obj) {
  return ((ScalaJS.is.sjs_js_JSNumberOps$ExtOps$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.scalajs.js.JSNumberOps$ExtOps$"))
});
ScalaJS.isArrayOf.sjs_js_JSNumberOps$ExtOps$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.sjs_js_JSNumberOps$ExtOps$)))
});
ScalaJS.asArrayOf.sjs_js_JSNumberOps$ExtOps$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.sjs_js_JSNumberOps$ExtOps$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.scalajs.js.JSNumberOps$ExtOps$;", depth))
});
ScalaJS.d.sjs_js_JSNumberOps$ExtOps$ = new ScalaJS.ClassTypeData({
  sjs_js_JSNumberOps$ExtOps$: 0
}, false, "scala.scalajs.js.JSNumberOps$ExtOps$", ScalaJS.d.O, {
  sjs_js_JSNumberOps$ExtOps$: 1,
  O: 1
});
ScalaJS.c.sjs_js_JSNumberOps$ExtOps$.prototype.$classData = ScalaJS.d.sjs_js_JSNumberOps$ExtOps$;
ScalaJS.n.sjs_js_JSNumberOps$ExtOps$ = (void 0);
ScalaJS.m.sjs_js_JSNumberOps$ExtOps$ = (function() {
  if ((!ScalaJS.n.sjs_js_JSNumberOps$ExtOps$)) {
    ScalaJS.n.sjs_js_JSNumberOps$ExtOps$ = new ScalaJS.c.sjs_js_JSNumberOps$ExtOps$().init___()
  };
  return ScalaJS.n.sjs_js_JSNumberOps$ExtOps$
});
/** @constructor */
ScalaJS.c.sjs_js_JSStringOps$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.sjs_js_JSStringOps$.prototype = new ScalaJS.h.O();
ScalaJS.c.sjs_js_JSStringOps$.prototype.constructor = ScalaJS.c.sjs_js_JSStringOps$;
/** @constructor */
ScalaJS.h.sjs_js_JSStringOps$ = (function() {
  /*<skip>*/
});
ScalaJS.h.sjs_js_JSStringOps$.prototype = ScalaJS.c.sjs_js_JSStringOps$.prototype;
ScalaJS.c.sjs_js_JSStringOps$.prototype.enableJSStringOps__T__sjs_js_JSStringOps = (function(x) {
  return x
});
ScalaJS.is.sjs_js_JSStringOps$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sjs_js_JSStringOps$)))
});
ScalaJS.as.sjs_js_JSStringOps$ = (function(obj) {
  return ((ScalaJS.is.sjs_js_JSStringOps$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.scalajs.js.JSStringOps$"))
});
ScalaJS.isArrayOf.sjs_js_JSStringOps$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.sjs_js_JSStringOps$)))
});
ScalaJS.asArrayOf.sjs_js_JSStringOps$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.sjs_js_JSStringOps$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.scalajs.js.JSStringOps$;", depth))
});
ScalaJS.d.sjs_js_JSStringOps$ = new ScalaJS.ClassTypeData({
  sjs_js_JSStringOps$: 0
}, false, "scala.scalajs.js.JSStringOps$", ScalaJS.d.O, {
  sjs_js_JSStringOps$: 1,
  O: 1
});
ScalaJS.c.sjs_js_JSStringOps$.prototype.$classData = ScalaJS.d.sjs_js_JSStringOps$;
ScalaJS.n.sjs_js_JSStringOps$ = (void 0);
ScalaJS.m.sjs_js_JSStringOps$ = (function() {
  if ((!ScalaJS.n.sjs_js_JSStringOps$)) {
    ScalaJS.n.sjs_js_JSStringOps$ = new ScalaJS.c.sjs_js_JSStringOps$().init___()
  };
  return ScalaJS.n.sjs_js_JSStringOps$
});
ScalaJS.s.sjs_js_LowPrioAnyImplicits$class__$$init$__sjs_js_LowPrioAnyImplicits__V = (function($$this) {
  /*<skip>*/
});
/** @constructor */
ScalaJS.c.sjs_js_package$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.sjs_js_package$.prototype = new ScalaJS.h.O();
ScalaJS.c.sjs_js_package$.prototype.constructor = ScalaJS.c.sjs_js_package$;
/** @constructor */
ScalaJS.h.sjs_js_package$ = (function() {
  /*<skip>*/
});
ScalaJS.h.sjs_js_package$.prototype = ScalaJS.c.sjs_js_package$.prototype;
ScalaJS.c.sjs_js_package$.prototype.$undefined__sjs_js_UndefOr = (function() {
  return (void 0)
});
ScalaJS.c.sjs_js_package$.prototype.isUndefined__O__Z = (function(v) {
  return (v === this.$undefined__sjs_js_UndefOr())
});
ScalaJS.is.sjs_js_package$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sjs_js_package$)))
});
ScalaJS.as.sjs_js_package$ = (function(obj) {
  return ((ScalaJS.is.sjs_js_package$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.scalajs.js.package$"))
});
ScalaJS.isArrayOf.sjs_js_package$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.sjs_js_package$)))
});
ScalaJS.asArrayOf.sjs_js_package$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.sjs_js_package$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.scalajs.js.package$;", depth))
});
ScalaJS.d.sjs_js_package$ = new ScalaJS.ClassTypeData({
  sjs_js_package$: 0
}, false, "scala.scalajs.js.package$", ScalaJS.d.O, {
  sjs_js_package$: 1,
  O: 1
});
ScalaJS.c.sjs_js_package$.prototype.$classData = ScalaJS.d.sjs_js_package$;
ScalaJS.n.sjs_js_package$ = (void 0);
ScalaJS.m.sjs_js_package$ = (function() {
  if ((!ScalaJS.n.sjs_js_package$)) {
    ScalaJS.n.sjs_js_package$ = new ScalaJS.c.sjs_js_package$().init___()
  };
  return ScalaJS.n.sjs_js_package$
});
/** @constructor */
...
ScalaJS.c.sjsr_Bits$.prototype.areTypedArraysSupported__Z = (function() {
  return this.areTypedArraysSupported$1
});
ScalaJS.c.sjsr_Bits$.prototype.arrayBuffer__p1__sjs_js_typedarray_ArrayBuffer = (function() {
  return this.arrayBuffer$1
});
ScalaJS.c.sjsr_Bits$.prototype.int32Array__p1__sjs_js_typedarray_Int32Array = (function() {
  return this.int32Array$1
});
ScalaJS.c.sjsr_Bits$.prototype.float64Array__p1__sjs_js_typedarray_Float64Array = (function() {
  return this.float64Array$1
});
ScalaJS.c.sjsr_Bits$.prototype.areTypedArraysBigEndian__Z = (function() {
  return this.areTypedArraysBigEndian$1
});
ScalaJS.c.sjsr_Bits$.prototype.highOffset__p1__I = (function() {
  return this.highOffset$1
});
ScalaJS.c.sjsr_Bits$.prototype.lowOffset__p1__I = (function() {
  return this.lowOffset$1
});
ScalaJS.c.sjsr_Bits$.prototype.numberHashCode__D__I = (function(value) {
  var iv = (value | 0);
  return (((iv === value) && ((1.0 / value) !== (-Infinity))) ? iv : ScalaJS.objectHashCode(this.doubleToLongBits__D__J(value)))
});
ScalaJS.c.sjsr_Bits$.prototype.doubleToLongBits__D__J = (function(value) {
  if (this.areTypedArraysSupported__Z()) {
    ...
    return new ScalaJS.c.sjsr_RuntimeLong().init___I(ScalaJS.uI(this.int32Array__p1__sjs_js_typedarray_Int32Array()[this.highOffset__p1__I()])).$$less$less__I__sjsr_RuntimeLong(32).$$bar__sjsr_RuntimeLong__sjsr_RuntimeLong(new ScalaJS.c.sjsr_RuntimeLong().init___I(ScalaJS.uI(this.int32Array__p1__sjs_js_typedarray_Int32Array()[this.lowOffset__p1__I()])).$$amp__sjsr_RuntimeLong__sjsr_RuntimeLong(new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(4194303, 1023, 0)))
  } else {
...
ScalaJS.c.sjsr_Bits$.prototype.doubleToLongBitsPolyfill__p1__D__J = (function(value) {
  ...
  matchEnd3: {
    var x$2;
    if ((x1 !== null)) {
      var s = ScalaJS.uZ(x1.$$und1__O());
      var e = ScalaJS.uI(x1.$$und2__O());
      var f = ScalaJS.uD(x1.$$und3__O());
      var x$2 = new ScalaJS.c.T3().init___O__O__O(s, e, f);
      break matchEnd3
    };
    throw new ScalaJS.c.s_MatchError().init___O(x1)
  };
  var s$2 = ScalaJS.uZ(x$2.$$und1__O());
  var e$2 = ScalaJS.uI(x$2.$$und2__O());
  var f$2 = ScalaJS.uD(x$2.$$und3__O());
  var hif = ((f$2 / new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(0, 1024, 0).toDouble__D()) | 0);
  var hi = (((s$2 ? (-2147483648) : 0) | (e$2 << hifbits)) | hif);
  var lo = (f$2 | 0);
  return new ScalaJS.c.sjsr_RuntimeLong().init___I(hi).$$less$less__I__sjsr_RuntimeLong(32).$$bar__sjsr_RuntimeLong__sjsr_RuntimeLong(new ScalaJS.c.sjsr_RuntimeLong().init___I(lo).$$amp__sjsr_RuntimeLong__sjsr_RuntimeLong(new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(4194303, 1023, 0)))
});
ScalaJS.c.sjsr_Bits$.prototype.encodeIEEE754__p1__I__I__D__T3 = (function(ebits, fbits, v) {
  var bias = (((1 << ((ebits - 1) | 0)) - 1) | 0);
  if (ScalaJS.isNaN(ScalaJS.m.s_Predef$().double2Double__D__jl_Double(v))) {
    return new ScalaJS.c.T3().init___O__O__O(false, (((1 << ebits) - 1) | 0), ScalaJS.m.jl_Math$().pow__D__D__D(2.0, ((fbits - 1) | 0)))
  } else if (ScalaJS.isInfinite(ScalaJS.m.s_Predef$().double2Double__D__jl_Double(v))) {
    return new ScalaJS.c.T3().init___O__O__O((v < 0), (((1 << ebits) - 1) | 0), 0.0)
  } else if ((v === 0.0)) {
    return new ScalaJS.c.T3().init___O__O__O(((1 / v) === (-Infinity)), 0, 0.0)
  } else {
    var LN2 = 0.6931471805599453;
    var s = (v < 0);
    var av = (s ? (-v) : v);
    if ((av >= ScalaJS.m.jl_Math$().pow__D__D__D(2.0, ((1 - bias) | 0)))) {
      var twoPowFbits = ScalaJS.m.jl_Math$().pow__D__D__D(2.0, fbits);
      var e = ScalaJS.m.jl_Math$().min__I__I__I((ScalaJS.m.jl_Math$().floor__D__D((ScalaJS.m.jl_Math$().log__D__D(av) / LN2)) | 0), 1023);
      var f = this.roundToEven__D__D(((av / ScalaJS.m.jl_Math$().pow__D__D__D(2.0, e)) * twoPowFbits));
      if (((f / twoPowFbits) >= 2)) {
        e = ((e + 1) | 0);
        f = 1.0
      };
      ...
      return new ScalaJS.c.T3().init___O__O__O(s, e, f)
    } else {
      return new ScalaJS.c.T3().init___O__O__O(s, 0, this.roundToEven__D__D((av / ScalaJS.m.jl_Math$().pow__D__D__D(2.0, ((((1 - bias) | 0) - fbits) | 0)))))
    }
  }
});
ScalaJS.c.sjsr_Bits$.prototype.roundToEven__D__D = (function(n) {
  var w = ScalaJS.m.jl_Math$().floor__D__D(n);
  var f = (n - w);
...
ScalaJS.c.sjsr_Bits$.prototype.init___ = (function() {
  ...
  this.areTypedArraysSupported$1 = ScalaJS.m.sjs_js_DynamicImplicits$().truthValue__sjs_js_Dynamic__Z((((ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["ArrayBuffer"] && ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["Int32Array"]) && ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["Float32Array"]) && ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["Float64Array"]));
  this.arrayBuffer$1 = (this.areTypedArraysSupported__Z() ? new ScalaJS.g["ArrayBuffer"](8) : null);
  this.int32Array$1 = (this.areTypedArraysSupported__Z() ? new ScalaJS.g["Int32Array"](this.arrayBuffer__p1__sjs_js_typedarray_ArrayBuffer(), 0, 2) : null);
  this.float32Array$1 = (this.areTypedArraysSupported__Z() ? new ScalaJS.g["Float32Array"](this.arrayBuffer__p1__sjs_js_typedarray_ArrayBuffer(), 0, 2) : null);
  this.float64Array$1 = (this.areTypedArraysSupported__Z() ? new ScalaJS.g["Float64Array"](this.arrayBuffer__p1__sjs_js_typedarray_ArrayBuffer(), 0, 1) : null);
  if (this.areTypedArraysSupported__Z()) {
    this.int32Array__p1__sjs_js_typedarray_Int32Array()[0] = 16909060;
    var jsx$1 = (ScalaJS.uB(new ScalaJS.g["Int8Array"](this.arrayBuffer__p1__sjs_js_typedarray_ArrayBuffer(), 0, 8)[0]) === 1)
  } else {
    var jsx$1 = true
  };
...
ScalaJS.c.sjsr_RuntimeString$.prototype.scala$scalajs$runtime$RuntimeString$$specialJSStringOps__T__sjsr_RuntimeString$SpecialJSStringOps = (function(s) {
  return s
});
ScalaJS.c.sjsr_RuntimeString$.prototype.charAt__T__I__C = (function(thiz, index) {
  return (ScalaJS.uI(this.scala$scalajs$runtime$RuntimeString$$specialJSStringOps__T__sjsr_RuntimeString$SpecialJSStringOps(thiz)["charCodeAt"](index)) & 65535)
});
ScalaJS.c.sjsr_RuntimeString$.prototype.hashCode__T__I = (function(thiz) {
  var res = 0;
  var mul = 1;
  var i = ((ScalaJS.m.sjsr_RuntimeString$().length__T__I(thiz) - 1) | 0);
  while ((i >= 0)) {
    res = ((res + ScalaJS.imul(ScalaJS.m.sjsr_RuntimeString$().charAt__T__I__C(thiz, i), mul)) | 0);
    mul = ScalaJS.imul(mul, 31);
    i = ((i - 1) | 0)
  };
  return res
});
ScalaJS.c.sjsr_RuntimeString$.prototype.indexOf__T__I__I = (function(thiz, ch) {
  return ScalaJS.m.sjsr_RuntimeString$().indexOf__T__T__I(thiz, this.fromCodePoint__p1__I__T(ch))
});
ScalaJS.c.sjsr_RuntimeString$.prototype.indexOf__T__T__I = (function(thiz, str) {
  return ScalaJS.uI(ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps(thiz)["indexOf"](str))
});
ScalaJS.c.sjsr_RuntimeString$.prototype.lastIndexOf__T__I__I = (function(thiz, ch) {
  return ScalaJS.m.sjsr_RuntimeString$().lastIndexOf__T__T__I(thiz, this.fromCodePoint__p1__I__T(ch))
});
ScalaJS.c.sjsr_RuntimeString$.prototype.lastIndexOf__T__T__I = (function(thiz, str) {
  return ScalaJS.uI(ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps(thiz)["lastIndexOf"](str))
});
ScalaJS.c.sjsr_RuntimeString$.prototype.length__T__I = (function(thiz) {
  return ScalaJS.uI(this.scala$scalajs$runtime$RuntimeString$$specialJSStringOps__T__sjsr_RuntimeString$SpecialJSStringOps(thiz)["length"])
});
ScalaJS.c.sjsr_RuntimeString$.prototype.substring__T__I__T = (function(thiz, beginIndex) {
  return ScalaJS.as.T(ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps(thiz)["substring"](beginIndex))
});
ScalaJS.c.sjsr_RuntimeString$.prototype.substring__T__I__I__T = (function(thiz, beginIndex, endIndex) {
  return ScalaJS.as.T(ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps(thiz)["substring"](beginIndex, endIndex))
});
...
ScalaJS.c.sjsr_RuntimeString$.prototype.fromCodePoint__p1__I__T = (function(codePoint) {
  if (((codePoint & (~65535)) === 0)) {
    return this.fromCharCode__p1__sc_Seq__T(new ScalaJS.c.sjs_js_WrappedArray().init___sjs_js_Array([codePoint]))
  } else if (((codePoint < 0) || (codePoint > 1114111))) {
    throw new ScalaJS.c.jl_IllegalArgumentException().init___()
  } else {
    var offsetCp = ((codePoint - 65536) | 0);
    return this.fromCharCode__p1__sc_Seq__T(new ScalaJS.c.sjs_js_WrappedArray().init___sjs_js_Array([((offsetCp >> 10) | 55296), ((offsetCp & 1023) | 56320)]))
  }
});
ScalaJS.c.sjsr_RuntimeString$.prototype.fromCharCode__p1__sc_Seq__T = (function(charCodes) {
  var x = ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["String"];
  return ScalaJS.as.T(x["fromCharCode"]["apply"](x, []["concat"](ScalaJS.m.sjsr_package$().genTraversableOnce2jsArray__sc_GenTraversableOnce__sjs_js_Array(charCodes))))
});
...
ScalaJS.c.sjsr_StackTrace$.prototype.captureState__jl_Throwable__V = (function(throwable) {
  this.captureState__jl_Throwable__O__V(throwable, this.createException__p1__O())
});
ScalaJS.c.sjsr_StackTrace$.prototype.createException__p1__O = (function() {
  try {
    ...
    if (ScalaJS.is.jl_Throwable(e$2)) {
      var ex6 = ScalaJS.as.jl_Throwable(e$2);
      var x4 = ex6;
      ...
      throw ScalaJS.m.sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(ex6)
    } else {
      throw e
    }
  }
...
ScalaJS.c.sjsr_StackTrace$.prototype.init___ = (function() {
  ...
  var dict = {
    "O": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("java_lang_Object"),
    "T": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("java_lang_String"),
    "V": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_Unit"),
    "Z": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_Boolean"),
    "C": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_Char"),
    "B": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_Byte"),
    "S": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_Short"),
    "I": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_Int"),
    "J": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_Long"),
    "F": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_Float"),
    "D": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_Double")
  };
  var index = 0;
  while ((index <= 22)) {
    if ((index >= 2)) {
  ...
  this.decompressedPrefixes$1 = {
    "sjsr_": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_scalajs_runtime_"),
    "sjs_": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_scalajs_"),
    "sci_": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_collection_immutable_"),
    "scm_": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_collection_mutable_"),
    "scg_": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_collection_generic_"),
    "sc_": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_collection_"),
    "sr_": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_runtime_"),
    "s_": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("scala_"),
    "jl_": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("java_lang_"),
    "ju_": ScalaJS.m.sjs_js_JSStringOps$().enableJSStringOps__T__sjs_js_JSStringOps("java_util_")
  };
...
ScalaJS.c.sjsr_package$.prototype.wrapJavaScriptException__O__jl_Throwable = (function(e) {
  var x1 = e;
  if (ScalaJS.is.jl_Throwable(x1)) {
    var x2 = ScalaJS.as.jl_Throwable(x1);
    return x2
  };
...
ScalaJS.c.sjsr_package$.prototype.unwrapJavaScriptException__jl_Throwable__O = (function(th) {
  ...
  if (ScalaJS.is.sjs_js_JavaScriptException(x1)) {
    var x2 = ScalaJS.as.sjs_js_JavaScriptException(x1);
    var e = x2.exception__O();
    return e
  };
  return th
});
ScalaJS.c.sjsr_package$.prototype.genTraversableOnce2jsArray__sc_GenTraversableOnce__sjs_js_Array = (function(col) {
  var x1 = col;
  if (ScalaJS.is.sjs_js_ArrayOps(x1)) {
    var x2 = ScalaJS.as.sjs_js_ArrayOps(x1);
    return x2.result__sjs_js_Array()
  };
  if (ScalaJS.is.sjs_js_WrappedArray(x1)) {
    var x3 = ScalaJS.as.sjs_js_WrappedArray(x1);
  ...
  col.foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2, result) {
    return (function(x$2) {
      var x = x$2;
      return this$2.$$anonfun$3__p1__O__sjs_js_Array__I(x, result)
    })
  })(this, result)));
  return result
});
ScalaJS.c.sjsr_package$.prototype.$$anonfun$3__p1__O__sjs_js_Array__I = (function(x, result$1) {
...
ScalaJS.c.sr_BoxesRunTime$.prototype.boxToCharacter__C__jl_Character = (function(c) {
  return ScalaJS.m.jl_Character$().valueOf__C__jl_Character(c)
});
...
ScalaJS.c.sr_BoxesRunTime$.prototype.equalsNumNum__jl_Number__jl_Number__Z = (function(xn, yn) {
  var x1 = xn;
  if (((typeof x1) === "number")) {
    var x2 = ScalaJS.uD(x1);
    var x1$2 = yn;
    if (((typeof x1$2) === "number")) {
      var x2$2 = ScalaJS.uD(x1$2);
      return (x2 === x2$2)
    };
    if (ScalaJS.is.sjsr_RuntimeLong(x1$2)) {
      var x3 = ScalaJS.uJ(x1$2);
      return (x2 === x3.toDouble__D())
    };
    if (ScalaJS.is.s_math_ScalaNumber(x1$2)) {
      var x4 = ScalaJS.as.s_math_ScalaNumber(x1$2);
      return x4.equals__O__Z(x2)
    };
    return false
  };
  if (ScalaJS.is.sjsr_RuntimeLong(x1)) {
    var x3$2 = ScalaJS.uJ(x1);
    var x1$3 = yn;
    if (ScalaJS.is.sjsr_RuntimeLong(x1$3)) {
      var x2$3 = ScalaJS.uJ(x1$3);
      return x3$2.equals__sjsr_RuntimeLong__Z(x2$3)
    };
    if (((typeof x1$3) === "number")) {
      var x3$3 = ScalaJS.uD(x1$3);
      return (x3$2.toDouble__D() === x3$3)
    };
    if (ScalaJS.is.s_math_ScalaNumber(x1$3)) {
      var x4$2 = ScalaJS.as.s_math_ScalaNumber(x1$3);
...
ScalaJS.c.sr_BoxesRunTime$.prototype.equalsNumChar__p1__jl_Number__jl_Character__Z = (function(xn, yc) {
  ...
  if (ScalaJS.is.sjsr_RuntimeLong(x1)) {
    ...
    return x3.equals__sjsr_RuntimeLong__Z(new ScalaJS.c.sjsr_RuntimeLong().init___I(yc.charValue__C()))
  };
  return ((xn === null) ? (yc === null) : ScalaJS.objectEquals(xn, yc))
});
...
ScalaJS.c.sr_BoxesRunTime$.prototype.hashFromDouble__jl_Double__I = (function(n) {
  ...
  if ((iv === dv)) {
    ...
    return ((lv.toDouble__D() === dv) ? ScalaJS.objectHashCode(ScalaJS.m.jl_Long$().valueOf__J__jl_Long(lv)) : ScalaJS.objectHashCode(n))
  }
});
ScalaJS.c.sr_BoxesRunTime$.prototype.hashFromNumber__jl_Number__I = (function(n) {
  ...
  if (ScalaJS.is.sjsr_RuntimeLong(x1)) {
    var x3 = ScalaJS.as.sjsr_RuntimeLong(x1);
    return this.hashFromLong__jl_Long__I(x3)
  };
  if (((typeof x1) === "number")) {
    var x4 = ScalaJS.asDouble(x1);
...
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.$$js$exported$meth$main__O = (function() {
  return ScalaJS.s.sjs_js_JSApp$class__$$js$exported$meth$main__sjs_js_JSApp__O(this)
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.fieldWidth__I = (function() {
  return this.fieldWidth$1
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.fieldHeight__I = (function() {
  return this.fieldHeight$1
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.playerWidth__I = (function() {
  return this.playerWidth$1
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.playerHeight__I = (function() {
  return this.playerHeight$1
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.movingInterval__I = (function() {
  return this.movingInterval$1
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.player__Ltutorial_webapp_Player = (function() {
  return this.player$1
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.player$und$eq__Ltutorial_webapp_Player__V = (function(x$1) {
  this.player$1 = x$1
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.main__V = (function() {
  ...
  })(ctx2D), ((1000 / famerate) | 0))
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.render__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(ctx2D) {
  ctx2D["fillStyle"] = ScalaJS.m.sjs_js_Any$().fromString__T__sjs_js_Any("#FF0000");
  var x1 = this.player__Ltutorial_webapp_Player().will__s_Option();
  matchEnd5: {
    if (ScalaJS.is.s_Some(x1)) {
      var x2 = ScalaJS.as.s_Some(x1);
      var newPlayer = ScalaJS.as.Ltutorial_webapp_Rect2D(x2.x__O());
      var current = this.player__Ltutorial_webapp_Player().current__Ltutorial_webapp_Rect2D();
      ctx2D["clearRect"](current.x__I(), current.y__I(), current.width__I(), current.height__I());
      this.player$und$eq__Ltutorial_webapp_Player__V(new ScalaJS.c.Ltutorial_webapp_Player().init___Ltutorial_webapp_Rect2D__s_Option(newPlayer, ScalaJS.m.s_None$()));
      break matchEnd5
    };
  ...
  ctx2D["fillRect"](this.player__Ltutorial_webapp_Player().current__Ltutorial_webapp_Rect2D().x__I(), this.player__Ltutorial_webapp_Player().current__Ltutorial_webapp_Rect2D().y__I(), this.player__Ltutorial_webapp_Player().current__Ltutorial_webapp_Rect2D().width__I(), this.player__Ltutorial_webapp_Player().current__Ltutorial_webapp_Rect2D().height__I())
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.initCanvas__Lorg_scalajs_dom_raw_CanvasRenderingContext2D = (function() {
  ...
  canvas["width"] = this.fieldWidth__I();
  canvas["height"] = this.fieldHeight__I();
  canvas["style"]["backgroundColor"] = "black";
  return canvas["getContext"]("2d")
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.bindingKeyEvent__V = (function() {
  ScalaJS.g["document"]["body"]["onkeydown"] = (function(e$2) {
    var e = e$2;
    var keyCode = ScalaJS.uI(e["keyCode"]);
    var currentPlayer = ScalaJS.m.Ltutorial_webapp_TutorialApp$().player__Ltutorial_webapp_Player().current__Ltutorial_webapp_Rect2D();
    var x1 = keyCode;
    switch (x1) {
      case 38:
        {
          var newPlayer = new ScalaJS.c.s_Some().init___O(ScalaJS.m.Ltutorial_webapp_TutorialApp$().tutorial$webapp$TutorialApp$$getNewPlayer__Ltutorial_webapp_Rect2D__I__I__Ltutorial_webapp_Rect2D(currentPlayer, 0, ((-ScalaJS.m.Ltutorial_webapp_TutorialApp$().movingInterval__I()) | 0)));
          break
        };
      case 40:
        {
          var newPlayer = new ScalaJS.c.s_Some().init___O(ScalaJS.m.Ltutorial_webapp_TutorialApp$().tutorial$webapp$TutorialApp$$getNewPlayer__Ltutorial_webapp_Rect2D__I__I__Ltutorial_webapp_Rect2D(currentPlayer, 0, ScalaJS.m.Ltutorial_webapp_TutorialApp$().movingInterval__I()));
          break
        };
      case 37:
        {
          var newPlayer = new ScalaJS.c.s_Some().init___O(ScalaJS.m.Ltutorial_webapp_TutorialApp$().tutorial$webapp$TutorialApp$$getNewPlayer__Ltutorial_webapp_Rect2D__I__I__Ltutorial_webapp_Rect2D(currentPlayer, ((-ScalaJS.m.Ltutorial_webapp_TutorialApp$().movingInterval__I()) | 0), 0));
          break
        };
      case 39:
        {
          var newPlayer = new ScalaJS.c.s_Some().init___O(ScalaJS.m.Ltutorial_webapp_TutorialApp$().tutorial$webapp$TutorialApp$$getNewPlayer__Ltutorial_webapp_Rect2D__I__I__Ltutorial_webapp_Rect2D(currentPlayer, ScalaJS.m.Ltutorial_webapp_TutorialApp$().movingInterval__I(), 0));
          break
        };
      default:
...
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.updatePlayer__s_Option__V = (function(newPlayer) {
  this.player$und$eq__Ltutorial_webapp_Player__V(new ScalaJS.c.Ltutorial_webapp_Player().init___Ltutorial_webapp_Rect2D__s_Option(this.player__Ltutorial_webapp_Player().current__Ltutorial_webapp_Rect2D(), newPlayer))
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.tutorial$webapp$TutorialApp$$getNewPlayer__Ltutorial_webapp_Rect2D__I__I__Ltutorial_webapp_Rect2D = (function(player, xIncrease, yIncrease) {
  var willX = ((player.x__I() + xIncrease) | 0);
  var maxX = ((this.fieldWidth__I() - player.width__I()) | 0);
  var newX = ((willX > maxX) ? maxX : ((willX < 0) ? 0 : willX));
  var willY = ((player.y__I() + yIncrease) | 0);
  var maxY = ((this.fieldHeight__I() - player.height__I()) | 0);
  var newY = ((willY > maxY) ? maxY : ((willY < 0) ? 0 : willY));
  return new ScalaJS.c.Ltutorial_webapp_Rect2D().init___I__I__I__I(newX, newY, player.width__I(), player.height__I())
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.init___ = (function() {
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.n.Ltutorial_webapp_TutorialApp$ = this;
  ScalaJS.s.sjs_js_JSApp$class__$$init$__sjs_js_JSApp__V(this);
  this.fieldWidth$1 = 480;
  this.fieldHeight$1 = 360;
  this.playerWidth$1 = 25;
  this.playerHeight$1 = 25;
  this.movingInterval$1 = 50;
  var initialPosition = new ScalaJS.c.Ltutorial_webapp_Point().init___I__I(((((this.fieldWidth__I() / 2) | 0) - ((this.playerWidth__I() / 2) | 0)) | 0), ((((this.fieldHeight__I() / 2) | 0) - ((this.playerHeight__I() / 2) | 0)) | 0));
  this.player$1 = new ScalaJS.c.Ltutorial_webapp_Player().init___Ltutorial_webapp_Rect2D__s_Option(new ScalaJS.c.Ltutorial_webapp_Rect2D().init___I__I__I__I(initialPosition.x__I(), initialPosition.y__I(), this.playerWidth__I(), this.playerHeight__I()), ScalaJS.m.s_None$());
  return this
});
...
ScalaJS.c.jl_Character.prototype.toString__T = (function() {
  return ScalaJS.m.jl_Character$().toString__C__T(this.value__p1__C())
});
...
ScalaJS.c.sci_List$$anon$1.prototype.toString__T = (function() {
  return ScalaJS.s.s_Function1$class__toString__F1__T(this)
});
...
ScalaJS.c.sci_List$$anon$1.prototype.init___ = (function() {
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.s.s_Function1$class__$$init$__F1__V(this);
  return this
});
...
ScalaJS.c.sjs_js_Any$.prototype.fromInt__I__sjs_js_Any = (function(value) {
  return value
});
ScalaJS.c.sjs_js_Any$.prototype.fromString__T__sjs_js_Any = (function(s) {
  return s
});
ScalaJS.c.sjs_js_Any$.prototype.init___ = (function() {
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.n.sjs_js_Any$ = this;
  ScalaJS.s.sjs_js_LowPrioAnyImplicits$class__$$init$__sjs_js_LowPrioAnyImplicits__V(this);
  return this
});
...
ScalaJS.as.sjs_js_Any$ = (function(obj) {
  return ((ScalaJS.is.sjs_js_Any$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.scalajs.js.Any$"))
});
...
ScalaJS.asArrayOf.sjs_js_Any$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.sjs_js_Any$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.scalajs.js.Any$;", depth))
});
...
ScalaJS.c.sr_AbstractFunction0.prototype.toString__T = (function() {
  return ScalaJS.s.s_Function0$class__toString__F0__T(this)
});
ScalaJS.c.sr_AbstractFunction0.prototype.init___ = (function() {
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.s.s_Function0$class__$$init$__F0__V(this);
  return this
});
...
ScalaJS.c.s_Console$.prototype.init___ = (function() {
  ...
  ScalaJS.s.s_io_AnsiColor$class__$$init$__s_io_AnsiColor__V(this);
...
ScalaJS.c.s_Predef$.prototype.double2Double__D__jl_Double = (function(x) {
  return ScalaJS.m.jl_Double$().valueOf__D__jl_Double(x)
});
ScalaJS.c.s_Predef$.prototype.boolean2Boolean__Z__jl_Boolean = (function(x) {
  return ScalaJS.m.jl_Boolean$().valueOf__Z__jl_Boolean(x)
});
...
ScalaJS.c.s_Predef$.prototype.init___ = (function() {
  ...
  ScalaJS.s.s_DeprecatedPredef$class__$$init$__s_Predef$__V(this);
  ScalaJS.m.s_package$();
  ScalaJS.m.sci_List$();
...
ScalaJS.c.sjsr_RuntimeLong.prototype.masked__p2__I__I__I__sjsr_RuntimeLong = (function(l, m, h) {
  return new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I((l & 4194303), (m & 4194303), (h & 1048575))
});
...
ScalaJS.c.sjsr_RuntimeLong.prototype.toLong__J = (function() {
...
ScalaJS.c.sjsr_RuntimeLong.prototype.toDouble__D = (function() {
  return (this.isMinValue__p2__Z() ? (-9.223372036854776E18) : (this.scala$scalajs$runtime$RuntimeLong$$isNegative__Z() ? (-this.unary$und$minus__sjsr_RuntimeLong().toDouble__D()) : ((this.l__I() + (this.m__I() * 4194304.0)) + (this.h__I() * 1.7592186044416E13))))
});
...
ScalaJS.c.sjsr_RuntimeLong.prototype.unary$und$tilde__sjsr_RuntimeLong = (function() {
  return this.masked__p2__I__I__I__sjsr_RuntimeLong((~this.l__I()), (~this.m__I()), (~this.h__I()))
});
ScalaJS.c.sjsr_RuntimeLong.prototype.unary$und$minus__sjsr_RuntimeLong = (function() {
  var neg0 = ((((~this.l__I()) + 1) | 0) & 4194303);
  var neg1 = ((((~this.m__I()) + ((neg0 === 0) ? 1 : 0)) | 0) & 4194303);
  var neg2 = ((((~this.h__I()) + (((neg0 === 0) && (neg1 === 0)) ? 1 : 0)) | 0) & 1048575);
...
ScalaJS.c.sjsr_RuntimeLong.prototype.$$less$less__I__sjsr_RuntimeLong = (function(n_in) {
  ...
  if ((n < 22)) {
    var remBits = ((22 - n) | 0);
    return this.masked__p2__I__I__I__sjsr_RuntimeLong((this.l__I() << n), ((this.m__I() << n) | (this.l__I() >> remBits)), ((this.h__I() << n) | (this.m__I() >> remBits)))
  } else if ((n < 44)) {
    var shfBits = ((n - 22) | 0);
    var remBits$2 = ((44 - n) | 0);
    return this.masked__p2__I__I__I__sjsr_RuntimeLong(0, (this.l__I() << shfBits), ((this.m__I() << shfBits) | (this.l__I() >> remBits$2)))
  } else {
    return this.masked__p2__I__I__I__sjsr_RuntimeLong(0, 0, (this.l__I() << ((n - 44) | 0)))
  }
});
ScalaJS.c.sjsr_RuntimeLong.prototype.$$greater$greater$greater__I__sjsr_RuntimeLong = (function(n_in) {
  ...
  if ((n < 22)) {
    var remBits = ((22 - n) | 0);
    return this.masked__p2__I__I__I__sjsr_RuntimeLong(((this.l__I() >> n) | (this.m__I() << remBits)), ((this.m__I() >> n) | (this.h__I() << remBits)), ((this.h__I() >>> n) | 0))
  } else if ((n < 44)) {
    var shfBits = ((n - 22) | 0);
    var remBits$2 = ((44 - n) | 0);
    return this.masked__p2__I__I__I__sjsr_RuntimeLong(((this.m__I() >> shfBits) | (this.h__I() << remBits$2)), ((this.h__I() >>> shfBits) | 0), 0)
  } else {
    return this.masked__p2__I__I__I__sjsr_RuntimeLong(((this.h__I() >>> ((n - 44) | 0)) | 0), 0, 0)
  }
});
ScalaJS.c.sjsr_RuntimeLong.prototype.$$greater$greater__I__sjsr_RuntimeLong = (function(n_in) {
  var n = (n_in & 63);
  var negative = ((this.h__I() & 524288) !== 0);
  var xh = (negative ? (this.h__I() | (~1048575)) : this.h__I());
  if ((n < 22)) {
    var remBits = ((22 - n) | 0);
    return this.masked__p2__I__I__I__sjsr_RuntimeLong(((this.l__I() >> n) | (this.m__I() << remBits)), ((this.m__I() >> n) | (xh << remBits)), (xh >> n))
  } else if ((n < 44)) {
    var shfBits = ((n - 22) | 0);
    var remBits$2 = ((44 - n) | 0);
    return this.masked__p2__I__I__I__sjsr_RuntimeLong(((this.m__I() >> shfBits) | (xh << remBits$2)), (xh >> shfBits), (negative ? 1048575 : 0))
  } else {
    return this.masked__p2__I__I__I__sjsr_RuntimeLong((xh >> ((n - 44) | 0)), (negative ? 4194303 : 0), (negative ? 1048575 : 0))
  }
});
ScalaJS.c.sjsr_RuntimeLong.prototype.equals__sjsr_RuntimeLong__Z = (function(y) {
  return (((this.l__I() === y.l__I()) && (this.m__I() === y.m__I())) && (this.h__I() === y.h__I()))
});
...
ScalaJS.c.sjsr_RuntimeLong.prototype.$$greater__sjsr_RuntimeLong__Z = (function(y) {
  return ((!this.scala$scalajs$runtime$RuntimeLong$$isNegative__Z()) ? (((y.scala$scalajs$runtime$RuntimeLong$$isNegative__Z() || (this.h__I() > y.h__I())) || ((this.h__I() === y.h__I()) && (this.m__I() > y.m__I()))) || (((this.h__I() === y.h__I()) && (this.m__I() === y.m__I())) && (this.l__I() > y.l__I()))) : (!((((!y.scala$scalajs$runtime$RuntimeLong$$isNegative__Z()) || (this.h__I() < y.h__I())) || ((this.h__I() === y.h__I()) && (this.m__I() < y.m__I()))) || (((this.h__I() === y.h__I()) && (this.m__I() === y.m__I())) && (this.l__I() <= y.l__I())))))
});
...
ScalaJS.c.sjsr_RuntimeLong.prototype.$$bar__sjsr_RuntimeLong__sjsr_RuntimeLong = (function(y) {
  return new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I((this.l__I() | y.l__I()), (this.m__I() | y.m__I()), (this.h__I() | y.h__I()))
});
...
ScalaJS.c.sjsr_RuntimeLong.prototype.$$plus__sjsr_RuntimeLong__sjsr_RuntimeLong = (function(y) {
  ...
  return this.masked__p2__I__I__I__sjsr_RuntimeLong(sum0, sum1, sum2)
});
...
ScalaJS.c.sjsr_RuntimeLong.prototype.$$times__sjsr_RuntimeLong__sjsr_RuntimeLong = (function(y) {
  ...
  var c1n = ((c1 + (c0 >> 22)) | 0);
  return this.masked__p2__I__I__I__sjsr_RuntimeLong(c0, c1n, ((c2 + (c1n >> 22)) | 0))
});
...
ScalaJS.c.sjsr_RuntimeLong.prototype.toString__T = (function() {
  if (this.scala$scalajs$runtime$RuntimeLong$$isZero__Z()) {
    ...
    var tenPow9 = ScalaJS.m.sjsr_RuntimeLong$().TenPow9__sjsr_RuntimeLong();
    return this.toString0$1__p2__sjsr_RuntimeLong__T__sjsr_RuntimeLong__T(this, "", tenPow9)
  }
});
...
ScalaJS.c.sjsr_RuntimeLong.prototype.isMinValue__p2__Z = (function() {
  return this.equals__sjsr_RuntimeLong__Z(ScalaJS.m.sjsr_RuntimeLong$().MinValue__sjsr_RuntimeLong())
});
ScalaJS.c.sjsr_RuntimeLong.prototype.scala$scalajs$runtime$RuntimeLong$$isNegative__Z = (function() {
  return ((this.h__I() & 524288) !== 0)
});
ScalaJS.c.sjsr_RuntimeLong.prototype.abs__p2__sjsr_RuntimeLong = (function() {
  return (this.scala$scalajs$runtime$RuntimeLong$$isNegative__Z() ? this.unary$und$minus__sjsr_RuntimeLong() : this)
});
ScalaJS.c.sjsr_RuntimeLong.prototype.numberOfLeadingZeros__I = (function() {
  return ((this.h__I() !== 0) ? ((ScalaJS.m.jl_Integer$().numberOfLeadingZeros__I__I(this.h__I()) - 12) | 0) : ((this.m__I() !== 0) ? ((((ScalaJS.m.jl_Integer$().numberOfLeadingZeros__I__I(this.m__I()) - 10) | 0) + 20) | 0) : ((((ScalaJS.m.jl_Integer$().numberOfLeadingZeros__I__I(this.l__I()) - 10) | 0) + 42) | 0)))
});
ScalaJS.c.sjsr_RuntimeLong.prototype.powerOfTwo__p2__I = (function() {
  return (((((this.h__I() === 0) && (this.m__I() === 0)) && (this.l__I() !== 0)) && ((this.l__I() & ((this.l__I() - 1) | 0)) === 0)) ? ScalaJS.m.jl_Integer$().numberOfTrailingZeros__I__I(this.l__I()) : (((((this.h__I() === 0) && (this.m__I() !== 0)) && (this.l__I() === 0)) && ((this.m__I() & ((this.m__I() - 1) | 0)) === 0)) ? ((ScalaJS.m.jl_Integer$().numberOfTrailingZeros__I__I(this.m__I()) + 22) | 0) : (((((this.h__I() !== 0) && (this.m__I() === 0)) && (this.l__I() === 0)) && ((this.h__I() & ((this.h__I() - 1) | 0)) === 0)) ? ((ScalaJS.m.jl_Integer$().numberOfTrailingZeros__I__I(this.h__I()) + 44) | 0) : (-1))))
});
ScalaJS.c.sjsr_RuntimeLong.prototype.scala$scalajs$runtime$RuntimeLong$$setBit__I__sjsr_RuntimeLong = (function(bit) {
  return ((bit < 22) ? new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I((this.l__I() | (1 << bit)), this.m__I(), this.h__I()) : ((bit < 44) ? new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(this.l__I(), (this.m__I() | (1 << ((bit - 22) | 0))), this.h__I()) : new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(this.l__I(), this.m__I(), (this.h__I() | (1 << ((bit - 44) | 0))))))
});
ScalaJS.c.sjsr_RuntimeLong.prototype.scala$scalajs$runtime$RuntimeLong$$divMod__sjsr_RuntimeLong__sjs_js_Array = (function(y) {
  if (y.scala$scalajs$runtime$RuntimeLong$$isZero__Z()) {
    ...
    return (this.isMinValue__p2__Z() ? [ScalaJS.m.sjsr_RuntimeLong$().One__sjsr_RuntimeLong(), ScalaJS.m.sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong()] : [ScalaJS.m.sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong(), this])
  } else {
    ...
    if ((pow >= 0)) {
      if (xMinValue) {
        ...
        return [(yNegative ? z.unary$und$minus__sjsr_RuntimeLong() : z), ScalaJS.m.sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong()]
      } else {
      ...
      if (xMinValue) {
        var newX = ScalaJS.m.sjsr_RuntimeLong$().MaxValue__sjsr_RuntimeLong()
      } else {
        var absX$2 = this.abs__p2__sjsr_RuntimeLong();
        if (absX$2.$$less__sjsr_RuntimeLong__Z(absY)) {
          var newX;
      ...
      return this.divModHelper__p2__sjsr_RuntimeLong__sjsr_RuntimeLong__Z__Z__Z__sjs_js_Array(newX, absY, xNegative, yNegative, xMinValue)
    }
  }
});
ScalaJS.c.sjsr_RuntimeLong.prototype.maskRight__p2__I__sjsr_RuntimeLong = (function(bits) {
  return ((bits <= 22) ? new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I((this.l__I() & (((1 << bits) - 1) | 0)), 0, 0) : ((bits <= 44) ? new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(this.l__I(), (this.m__I() & (((1 << ((bits - 22) | 0)) - 1) | 0)), 0) : new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(this.l__I(), this.m__I(), (this.h__I() & (((1 << ((bits - 44) | 0)) - 1) | 0)))))
});
ScalaJS.c.sjsr_RuntimeLong.prototype.divModHelper__p2__sjsr_RuntimeLong__sjsr_RuntimeLong__Z__Z__Z__sjs_js_Array = (function(x, y, xNegative, yNegative, xMinValue) {
  var shift = ((y.numberOfLeadingZeros__I() - x.numberOfLeadingZeros__I()) | 0);
  var yShift = y.$$less$less__I__sjsr_RuntimeLong(shift);
  var x1 = this.divide0$1__p2__I__sjsr_RuntimeLong__sjsr_RuntimeLong__sjsr_RuntimeLong__T2(shift, yShift, x, ScalaJS.m.sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong());
  matchEnd3: {
    var x$3;
    if ((x1 !== null)) {
      var absQuot = ScalaJS.as.sjsr_RuntimeLong(x1.$$und1__O());
      var absRem = ScalaJS.as.sjsr_RuntimeLong(x1.$$und2__O());
      var x$3 = new ScalaJS.c.T2().init___O__O(absQuot, absRem);
      break matchEnd3
    };
    throw new ScalaJS.c.s_MatchError().init___O(x1)
  };
  var absQuot$2 = ScalaJS.as.sjsr_RuntimeLong(x$3.$$und1__O());
  var absRem$2 = ScalaJS.as.sjsr_RuntimeLong(x$3.$$und2__O());
  var quot = ((xNegative !== yNegative) ? absQuot$2.unary$und$minus__sjsr_RuntimeLong() : absQuot$2);
  var rem = ((xNegative && xMinValue) ? absRem$2.unary$und$minus__sjsr_RuntimeLong().$$minus__sjsr_RuntimeLong__sjsr_RuntimeLong(ScalaJS.m.sjsr_RuntimeLong$().One__sjsr_RuntimeLong()) : (xNegative ? absRem$2.unary$und$minus__sjsr_RuntimeLong() : absRem$2));
  return [quot, rem]
});
ScalaJS.c.sjsr_RuntimeLong.prototype.compareTo__O__I = (function(x$1) {
  return this.compareTo__jl_Long__I(ScalaJS.as.sjsr_RuntimeLong(x$1))
});
...
ScalaJS.c.sjsr_RuntimeLong.prototype.toString0$1__p2__sjsr_RuntimeLong__T__sjsr_RuntimeLong__T = (function(v, acc, tenPow9$1) {
  var _$this = this;
  _toString0: while (true) {
    if (v.scala$scalajs$runtime$RuntimeLong$$isZero__Z()) {
      return acc
    } else {
      var quotRem = v.scala$scalajs$runtime$RuntimeLong$$divMod__sjsr_RuntimeLong__sjs_js_Array(tenPow9$1);
      ...
      var zeroPrefix = (quot.scala$scalajs$runtime$RuntimeLong$$isZero__Z() ? "" : ScalaJS.m.sjsr_RuntimeString$().substring__T__I__T("000000000", ScalaJS.m.sjsr_RuntimeString$().length__T__I(digits)));
      var temp$v = quot;
...
ScalaJS.c.sjsr_RuntimeLong.prototype.divide0$1__p2__I__sjsr_RuntimeLong__sjsr_RuntimeLong__sjsr_RuntimeLong__T2 = (function(shift, yShift, curX, quot) {
  var _$this = this;
  _divide0: while (true) {
    if (((shift < 0) || curX.scala$scalajs$runtime$RuntimeLong$$isZero__Z())) {
      return new ScalaJS.c.T2().init___O__O(quot, curX)
    } else {
...
ScalaJS.c.sjsr_RuntimeLong.prototype.init___I = (function(value) {
  ScalaJS.c.sjsr_RuntimeLong.prototype.init___I__I__I.call(this, (value & 4194303), ((value >> 22) & 4194303), ((value < 0) ? 1048575 : 0));
  return this
});
...
ScalaJS.c.sjsr_RuntimeLong$.prototype.TenPow9__sjsr_RuntimeLong = (function() {
  return this.TenPow9$1
});
...
ScalaJS.c.sr_BooleanRef$.prototype.$classData = ScalaJS.d.sr_BooleanRef$;
ScalaJS.n.sr_BooleanRef$ = (void 0);
...
ScalaJS.c.jl_StringBuilder.prototype.length__I = (function() {
  return ScalaJS.m.sjsr_RuntimeString$().length__T__I(this.content__p1__T())
});
ScalaJS.c.jl_StringBuilder.prototype.charAt__I__C = (function(index) {
  return ScalaJS.m.sjsr_RuntimeString$().charAt__T__I__C(this.content__p1__T(), index)
});
...
ScalaJS.c.s_math_Equiv$.prototype.init___ = (function() {
  ...
  ScalaJS.s.s_math_LowPriorityEquiv$class__$$init$__s_math_Equiv$__V(this);
  return this
});
...
ScalaJS.c.s_math_Ordering$.prototype.init___ = (function() {
  ...
  ScalaJS.s.s_math_LowPriorityOrderingImplicits$class__$$init$__s_math_LowPriorityOrderingImplicits__V(this);
  return this
});
...
ScalaJS.c.sc_AbstractIterator.prototype.init___ = (function() {
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.s.sc_TraversableOnce$class__$$init$__sc_TraversableOnce__V(this);
  ScalaJS.s.sc_Iterator$class__$$init$__sc_Iterator__V(this);
  return this
});
...
ScalaJS.c.Ltutorial_webapp_Player.prototype.current__Ltutorial_webapp_Rect2D = (function() {
  return this.current$1
});
ScalaJS.c.Ltutorial_webapp_Player.prototype.will__s_Option = (function() {
  return this.will$1
});
...
ScalaJS.c.Ltutorial_webapp_Player.prototype.productElement__I__O = (function(x$1) {
  ...
  switch (x1) {
    case 0:
      {
        return this.current__Ltutorial_webapp_Rect2D();
        break
      };
    case 1:
      {
        return this.will__s_Option();
        break
      };
    default:
...
ScalaJS.c.Ltutorial_webapp_Player.prototype.canEqual__O__Z = (function(x$1) {
  return ScalaJS.is.Ltutorial_webapp_Player(x$1)
});
...
ScalaJS.c.Ltutorial_webapp_Player.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    matchEnd4: {
      var jsx$1;
      if (ScalaJS.is.Ltutorial_webapp_Player(x1)) {
        var jsx$1 = true;
        break matchEnd4
      };
      var jsx$1 = false;
    ...
    if (jsx$1) {
      ...
      var x = this.current__Ltutorial_webapp_Rect2D();
      var x$2 = Player$1.current__Ltutorial_webapp_Rect2D();
      if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
        var x$3 = this.will__s_Option();
        var x$4 = Player$1.will__s_Option();
        var jsx$2 = ((x$3 === null) ? (x$4 === null) : x$3.equals__O__Z(x$4))
      } else {
        var jsx$2 = false
      };
      if (jsx$2) {
        return Player$1.canEqual__O__Z(this)
      } else {
        return false
      }
    } else {
...
ScalaJS.c.Ltutorial_webapp_Player.prototype.init___Ltutorial_webapp_Rect2D__s_Option = (function(current, will) {
  ...
  this.will$1 = will;
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.s.s_Product$class__$$init$__s_Product__V(this);
  return this
});
...
ScalaJS.c.Ltutorial_webapp_Point.prototype.x__I = (function() {
  return this.x$1
});
ScalaJS.c.Ltutorial_webapp_Point.prototype.y__I = (function() {
  return this.y$1
});
...
ScalaJS.c.Ltutorial_webapp_Point.prototype.canEqual__O__Z = (function(x$1) {
  return ScalaJS.is.Ltutorial_webapp_Point(x$1)
});
ScalaJS.c.Ltutorial_webapp_Point.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = ScalaJS.m.sr_Statics$().mix__I__I__I(acc, this.x__I());
  acc = ScalaJS.m.sr_Statics$().mix__I__I__I(acc, this.y__I());
...
ScalaJS.c.Ltutorial_webapp_Point.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    matchEnd4: {
      var jsx$1;
      if (ScalaJS.is.Ltutorial_webapp_Point(x1)) {
        var jsx$1 = true;
        break matchEnd4
      };
      var jsx$1 = false;
    ...
    if (jsx$1) {
      ...
      return (((this.x__I() === Point$1.x__I()) && (this.y__I() === Point$1.y__I())) && Point$1.canEqual__O__Z(this))
    } else {
      return false
    }
  }
...
ScalaJS.c.Ltutorial_webapp_Rect2D.prototype.x__I = (function() {
  return this.x$1
});
ScalaJS.c.Ltutorial_webapp_Rect2D.prototype.y__I = (function() {
  return this.y$1
});
ScalaJS.c.Ltutorial_webapp_Rect2D.prototype.width__I = (function() {
  return this.width$1
});
ScalaJS.c.Ltutorial_webapp_Rect2D.prototype.height__I = (function() {
...
ScalaJS.c.Ltutorial_webapp_Rect2D.prototype.canEqual__O__Z = (function(x$1) {
  return ScalaJS.is.Ltutorial_webapp_Rect2D(x$1)
});
ScalaJS.c.Ltutorial_webapp_Rect2D.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = ScalaJS.m.sr_Statics$().mix__I__I__I(acc, this.x__I());
  acc = ScalaJS.m.sr_Statics$().mix__I__I__I(acc, this.y__I());
  acc = ScalaJS.m.sr_Statics$().mix__I__I__I(acc, this.width__I());
  acc = ScalaJS.m.sr_Statics$().mix__I__I__I(acc, this.height__I());
...
ScalaJS.c.Ltutorial_webapp_Rect2D.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    matchEnd4: {
      var jsx$1;
      if (ScalaJS.is.Ltutorial_webapp_Rect2D(x1)) {
        var jsx$1 = true;
        break matchEnd4
      };
      var jsx$1 = false;
    ...
    if (jsx$1) {
      ...
      return (((((this.x__I() === Rect2D$1.x__I()) && (this.y__I() === Rect2D$1.y__I())) && (this.width__I() === Rect2D$1.width__I())) && (this.height__I() === Rect2D$1.height__I())) && Rect2D$1.canEqual__O__Z(this))
    } else {
      return false
    }
  }
...
/** @constructor */
ScalaJS.c.jl_ArrayStoreException = (function() {
  ScalaJS.c.jl_RuntimeException.call(this)
});
ScalaJS.c.jl_ArrayStoreException.prototype = new ScalaJS.h.jl_RuntimeException();
ScalaJS.c.jl_ArrayStoreException.prototype.constructor = ScalaJS.c.jl_ArrayStoreException;
/** @constructor */
ScalaJS.h.jl_ArrayStoreException = (function() {
  /*<skip>*/
});
ScalaJS.h.jl_ArrayStoreException.prototype = ScalaJS.c.jl_ArrayStoreException.prototype;
ScalaJS.is.jl_ArrayStoreException = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.jl_ArrayStoreException)))
});
ScalaJS.as.jl_ArrayStoreException = (function(obj) {
  return ((ScalaJS.is.jl_ArrayStoreException(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "java.lang.ArrayStoreException"))
});
ScalaJS.isArrayOf.jl_ArrayStoreException = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.jl_ArrayStoreException)))
});
ScalaJS.asArrayOf.jl_ArrayStoreException = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.jl_ArrayStoreException(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Ljava.lang.ArrayStoreException;", depth))
});
ScalaJS.d.jl_ArrayStoreException = new ScalaJS.ClassTypeData({
  jl_ArrayStoreException: 0
}, false, "java.lang.ArrayStoreException", ScalaJS.d.jl_RuntimeException, {
...
ScalaJS.c.jl_ArrayStoreException.prototype.$classData = ScalaJS.d.jl_ArrayStoreException;
/** @constructor */
...
ScalaJS.c.s_util_control_BreakControl.prototype.init___ = (function() {
  ...
  ScalaJS.s.s_util_control_NoStackTrace$class__$$init$__s_util_control_NoStackTrace__V(this);
  return this
});
...
ScalaJS.c.T2.prototype.productArity__I = (function() {
  return ScalaJS.s.s_Product2$class__productArity__s_Product2__I(this)
});
...
ScalaJS.c.T2.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    if (jsx$1) {
      ...
      return ((ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und1__O(), Tuple2$1.$$und1__O()) && ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und2__O(), Tuple2$1.$$und2__O())) && Tuple2$1.canEqual__O__Z(this))
    } else {
      return false
    }
  }
...
ScalaJS.c.T2.prototype.init___O__O = (function(_1, _2) {
  ...
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.s.s_Product$class__$$init$__s_Product__V(this);
  ScalaJS.s.s_Product2$class__$$init$__s_Product2__V(this);
  return this
});
...
ScalaJS.c.T3.prototype.productArity__I = (function() {
  return ScalaJS.s.s_Product3$class__productArity__s_Product3__I(this)
});
...
ScalaJS.c.T3.prototype.$$und1__O = (function() {
  return this.$$und1$1
});
ScalaJS.c.T3.prototype.$$und2__O = (function() {
  return this.$$und2$1
});
ScalaJS.c.T3.prototype.$$und3__O = (function() {
  return this.$$und3$1
});
...
ScalaJS.c.T3.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    if (jsx$1) {
      ...
      return (((ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und1__O(), Tuple3$1.$$und1__O()) && ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und2__O(), Tuple3$1.$$und2__O())) && ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und3__O(), Tuple3$1.$$und3__O())) && Tuple3$1.canEqual__O__Z(this))
    } else {
      return false
    }
  }
...
ScalaJS.c.T3.prototype.init___O__O__O = (function(_1, _2, _3) {
  ...
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.s.s_Product$class__$$init$__s_Product__V(this);
  ScalaJS.s.s_Product3$class__$$init$__s_Product3__V(this);
  return this
});
...
ScalaJS.d.T3 = new ScalaJS.ClassTypeData({
  T3: 0
}, false, "scala.Tuple3", ScalaJS.d.O, {
  T3: 1,
  O: 1,
  s_Product3: 1,
  s_Product: 1,
...
ScalaJS.c.T5.prototype.productArity__I = (function() {
  return ScalaJS.s.s_Product5$class__productArity__s_Product5__I(this)
});
ScalaJS.c.T5.prototype.productElement__I__O = (function(n) {
  return ScalaJS.s.s_Product5$class__productElement__s_Product5__I__O(this, n)
});
...
ScalaJS.c.T5.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    if (jsx$1) {
      ...
      return (((((ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und1__O(), Tuple5$1.$$und1__O()) && ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und2__O(), Tuple5$1.$$und2__O())) && ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und3__O(), Tuple5$1.$$und3__O())) && ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und4__O(), Tuple5$1.$$und4__O())) && ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und5__O(), Tuple5$1.$$und5__O())) && Tuple5$1.canEqual__O__Z(this))
    } else {
      return false
    }
  }
...
ScalaJS.c.T5.prototype.init___O__O__O__O__O = (function(_1, _2, _3, _4, _5) {
  ...
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.s.s_Product$class__$$init$__s_Product__V(this);
  ScalaJS.s.s_Product5$class__$$init$__s_Product5__V(this);
  return this
});
...
/** @constructor */
ScalaJS.c.jl_ArrayIndexOutOfBoundsException = (function() {
  ScalaJS.c.jl_IndexOutOfBoundsException.call(this)
});
ScalaJS.c.jl_ArrayIndexOutOfBoundsException.prototype = new ScalaJS.h.jl_IndexOutOfBoundsException();
ScalaJS.c.jl_ArrayIndexOutOfBoundsException.prototype.constructor = ScalaJS.c.jl_ArrayIndexOutOfBoundsException;
/** @constructor */
ScalaJS.h.jl_ArrayIndexOutOfBoundsException = (function() {
  /*<skip>*/
});
ScalaJS.h.jl_ArrayIndexOutOfBoundsException.prototype = ScalaJS.c.jl_ArrayIndexOutOfBoundsException.prototype;
ScalaJS.is.jl_ArrayIndexOutOfBoundsException = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.jl_ArrayIndexOutOfBoundsException)))
});
ScalaJS.as.jl_ArrayIndexOutOfBoundsException = (function(obj) {
  return ((ScalaJS.is.jl_ArrayIndexOutOfBoundsException(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "java.lang.ArrayIndexOutOfBoundsException"))
});
ScalaJS.isArrayOf.jl_ArrayIndexOutOfBoundsException = (function(obj, depth) {
...
ScalaJS.asArrayOf.jl_ArrayIndexOutOfBoundsException = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.jl_ArrayIndexOutOfBoundsException(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Ljava.lang.ArrayIndexOutOfBoundsException;", depth))
});
ScalaJS.d.jl_ArrayIndexOutOfBoundsException = new ScalaJS.ClassTypeData({
  jl_ArrayIndexOutOfBoundsException: 0
}, false, "java.lang.ArrayIndexOutOfBoundsException", ScalaJS.d.jl_IndexOutOfBoundsException, {
...
ScalaJS.c.jl_ArrayIndexOutOfBoundsException.prototype.$classData = ScalaJS.d.jl_ArrayIndexOutOfBoundsException;
/** @constructor */
...
ScalaJS.c.s_Some.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    if (jsx$1) {
      ...
      return ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.x__O(), Some$1.x__O())
    } else {
      return false
    }
  }
...
ScalaJS.c.sci_VectorIterator.prototype.initFrom__sci_VectorPointer__V = (function(that) {
  ScalaJS.s.sci_VectorPointer$class__initFrom__sci_VectorPointer__sci_VectorPointer__V(this, that)
});
ScalaJS.c.sci_VectorIterator.prototype.initFrom__sci_VectorPointer__I__V = (function(that, depth) {
  ScalaJS.s.sci_VectorPointer$class__initFrom__sci_VectorPointer__sci_VectorPointer__I__V(this, that, depth)
});
ScalaJS.c.sci_VectorIterator.prototype.gotoPos__I__I__V = (function(index, xor) {
  ScalaJS.s.sci_VectorPointer$class__gotoPos__sci_VectorPointer__I__I__V(this, index, xor)
});
ScalaJS.c.sci_VectorIterator.prototype.gotoNextBlockStart__I__I__V = (function(index, xor) {
  ScalaJS.s.sci_VectorPointer$class__gotoNextBlockStart__sci_VectorPointer__I__I__V(this, index, xor)
});
...
ScalaJS.c.sci_VectorIterator.prototype.stabilize__I__V = (function(index) {
  ScalaJS.s.sci_VectorPointer$class__stabilize__sci_VectorPointer__I__V(this, index)
});
...
ScalaJS.c.sci_VectorIterator.prototype.init___I__I = (function(_startIndex, endIndex) {
  ...
  ScalaJS.c.sc_AbstractIterator.prototype.init___.call(this);
  ScalaJS.s.sci_VectorPointer$class__$$init$__sci_VectorPointer__V(this);
...
ScalaJS.c.jl_JSConsoleBasedPrintStream.prototype.flushed$und$eq__p4__Z__V = (function(x$1) {
  this.flushed$4 = x$1
});
ScalaJS.c.jl_JSConsoleBasedPrintStream.prototype.buffer__p4__T = (function() {
  return this.buffer$4
});
ScalaJS.c.jl_JSConsoleBasedPrintStream.prototype.buffer$und$eq__p4__T__V = (function(x$1) {
  this.buffer$4 = x$1
});
...
ScalaJS.c.jl_JSConsoleBasedPrintStream.prototype.println__V = (function() {
  this.printString__p4__T__V("\n")
});
ScalaJS.c.jl_JSConsoleBasedPrintStream.prototype.printString__p4__T__V = (function(s) {
  var rest = s;
  while ((!(rest === ""))) {
    var nlPos = ScalaJS.m.sjsr_RuntimeString$().indexOf__T__T__I(rest, "\n");
    if ((nlPos < 0)) {
      this.buffer$und$eq__p4__T__V((("" + this.buffer__p4__T()) + rest));
      this.flushed$und$eq__p4__Z__V(false);
      rest = ""
    } else {
      this.doWriteLine__p4__T__V((("" + this.buffer__p4__T()) + ScalaJS.m.sjsr_RuntimeString$().substring__T__I__I__T(rest, 0, nlPos)));
      this.buffer$und$eq__p4__T__V("");
      this.flushed$und$eq__p4__Z__V(true);
      rest = ScalaJS.m.sjsr_RuntimeString$().substring__T__I__T(rest, ((nlPos + 1) | 0))
    }
  }
});
ScalaJS.c.jl_JSConsoleBasedPrintStream.prototype.doWriteLine__p4__T__V = (function(line) {
  if (ScalaJS.m.sjs_js_DynamicImplicits$().truthValue__sjs_js_Dynamic__Z(ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["console"])) {
    if ((ScalaJS.m.s_Predef$().Boolean2boolean__jl_Boolean__Z(this.isErr$4) && ScalaJS.m.sjs_js_DynamicImplicits$().truthValue__sjs_js_Dynamic__Z(ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["console"]["error"]))) {
      ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["console"]["error"](ScalaJS.m.sjs_js_Any$().fromString__T__sjs_js_Any(line))
    } else {
      ScalaJS.m.sjs_js_Dynamic$().global__sjs_js_Dynamic()["console"]["log"](ScalaJS.m.sjs_js_Any$().fromString__T__sjs_js_Any(line))
    }
  }
});
...
ScalaJS.c.s_reflect_AnyValManifest.prototype.init___T = (function(toString) {
  ...
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.s.s_reflect_ClassManifestDeprecatedApis$class__$$init$__s_reflect_ClassTag__V(this);
  ScalaJS.s.s_reflect_ClassTag$class__$$init$__s_reflect_ClassTag__V(this);
  ScalaJS.s.s_reflect_Manifest$class__$$init$__s_reflect_Manifest__V(this);
...
ScalaJS.c.sc_IndexedSeqLike$Elements.prototype.init___sc_IndexedSeqLike__I__I = (function($$outer, start, end) {
  ...
  ScalaJS.c.sc_AbstractIterator.prototype.init___.call(this);
  ScalaJS.s.sc_BufferedIterator$class__$$init$__sc_BufferedIterator__V(this);
  this.index$2 = start;
  return this
});
...
ScalaJS.c.sjs_js_JavaScriptException.prototype.exception__O = (function() {
  return this.exception$4
});
ScalaJS.c.sjs_js_JavaScriptException.prototype.toString__T = (function() {
  return ScalaJS.objectToString(this.exception__O())
});
ScalaJS.c.sjs_js_JavaScriptException.prototype.fillInStackTrace__jl_Throwable = (function() {
  ScalaJS.m.sjsr_StackTrace$().captureState__jl_Throwable__O__V(this, this.exception__O());
  return this
});
...
ScalaJS.c.sjs_js_JavaScriptException.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    if (jsx$1) {
      ...
      return (ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.exception__O(), JavaScriptException$1.exception__O()) && JavaScriptException$1.canEqual__O__Z(this))
    } else {
      return false
    }
  }
...
ScalaJS.c.sc_AbstractTraversable.prototype.repr__O = (function() {
  return ScalaJS.s.sc_TraversableLike$class__repr__sc_TraversableLike__O(this)
});
...
ScalaJS.c.sc_AbstractTraversable.prototype.init___ = (function() {
  ScalaJS.c.O.prototype.init___.call(this);
  ScalaJS.s.sc_TraversableOnce$class__$$init$__sc_TraversableOnce__V(this);
  ScalaJS.s.sc_Parallelizable$class__$$init$__sc_Parallelizable__V(this);
  ScalaJS.s.sc_TraversableLike$class__$$init$__sc_TraversableLike__V(this);
  ScalaJS.s.scg_GenericTraversableTemplate$class__$$init$__scg_GenericTraversableTemplate__V(this);
  ScalaJS.s.sc_GenTraversable$class__$$init$__sc_GenTraversable__V(this);
  ScalaJS.s.sc_Traversable$class__$$init$__sc_Traversable__V(this);
  return this
});
...
ScalaJS.c.sc_AbstractIterable.prototype.foreach__F1__V = (function(f) {
  ScalaJS.s.sc_IterableLike$class__foreach__sc_IterableLike__F1__V(this, f)
});
...
ScalaJS.c.sc_AbstractIterable.prototype.canEqual__O__Z = (function(that) {
  return ScalaJS.s.sc_IterableLike$class__canEqual__sc_IterableLike__O__Z(this, that)
});
ScalaJS.c.sc_AbstractIterable.prototype.init___ = (function() {
  ScalaJS.c.sc_AbstractTraversable.prototype.init___.call(this);
  ScalaJS.s.sc_GenIterable$class__$$init$__sc_GenIterable__V(this);
  ScalaJS.s.sc_IterableLike$class__$$init$__sc_IterableLike__V(this);
  ScalaJS.s.sc_Iterable$class__$$init$__sc_Iterable__V(this);
  return this
});
...
ScalaJS.c.sc_AbstractSeq.prototype.toString__T = (function() {
  return ScalaJS.s.sc_SeqLike$class__toString__sc_SeqLike__T(this)
});
...
ScalaJS.c.sc_AbstractSeq.prototype.init___ = (function() {
  ...
  ScalaJS.s.s_Function1$class__$$init$__F1__V(this);
  ScalaJS.s.s_PartialFunction$class__$$init$__s_PartialFunction__V(this);
  ScalaJS.s.sc_GenSeqLike$class__$$init$__sc_GenSeqLike__V(this);
  ScalaJS.s.sc_GenSeq$class__$$init$__sc_GenSeq__V(this);
  ScalaJS.s.sc_SeqLike$class__$$init$__sc_SeqLike__V(this);
  ScalaJS.s.sc_Seq$class__$$init$__sc_Seq__V(this);
  return this
});
...
ScalaJS.c.scm_AbstractSeq.prototype.init___ = (function() {
  ...
  ScalaJS.s.scm_Traversable$class__$$init$__scm_Traversable__V(this);
  ScalaJS.s.scm_Iterable$class__$$init$__scm_Iterable__V(this);
  ScalaJS.s.scm_Cloneable$class__$$init$__scm_Cloneable__V(this);
  ScalaJS.s.scm_SeqLike$class__$$init$__scm_SeqLike__V(this);
  ScalaJS.s.scm_Seq$class__$$init$__scm_Seq__V(this);
  return this
});
...
ScalaJS.c.sci_List.prototype.seq__sci_LinearSeq = (function() {
  return ScalaJS.s.sci_LinearSeq$class__seq__sci_LinearSeq__sci_LinearSeq(this)
});
ScalaJS.c.sci_List.prototype.hashCode__I = (function() {
  return ScalaJS.s.sc_LinearSeqLike$class__hashCode__sc_LinearSeqLike__I(this)
});
ScalaJS.c.sci_List.prototype.iterator__sc_Iterator = (function() {
  return ScalaJS.s.sc_LinearSeqLike$class__iterator__sc_LinearSeqLike__sc_Iterator(this)
});
...
ScalaJS.c.sci_List.prototype.init___ = (function() {
  ScalaJS.c.sc_AbstractSeq.prototype.init___.call(this);
  ScalaJS.s.sci_Traversable$class__$$init$__sci_Traversable__V(this);
  ScalaJS.s.sci_Iterable$class__$$init$__sci_Iterable__V(this);
  ScalaJS.s.sci_Seq$class__$$init$__sci_Seq__V(this);
  ScalaJS.s.sc_LinearSeqLike$class__$$init$__sc_LinearSeqLike__V(this);
  ScalaJS.s.sc_LinearSeq$class__$$init$__sc_LinearSeq__V(this);
  ScalaJS.s.sci_LinearSeq$class__$$init$__sci_LinearSeq__V(this);
  ScalaJS.s.s_Product$class__$$init$__s_Product__V(this);
  ScalaJS.s.sc_LinearSeqOptimized$class__$$init$__sc_LinearSeqOptimized__V(this);
  return this
});
ScalaJS.is.sci_List = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sci_List)))
...
ScalaJS.c.sci_Vector.prototype.getElem__I__I__O = (function(index, xor) {
  return ScalaJS.s.sci_VectorPointer$class__getElem__sci_VectorPointer__I__I__O(this, index, xor)
});
ScalaJS.c.sci_Vector.prototype.copyOf__AO__AO = (function(a) {
  return ScalaJS.s.sci_VectorPointer$class__copyOf__sci_VectorPointer__AO__AO(this, a)
});
ScalaJS.c.sci_Vector.prototype.seq__sci_IndexedSeq = (function() {
  return ScalaJS.s.sci_IndexedSeq$class__seq__sci_IndexedSeq__sci_IndexedSeq(this)
});
ScalaJS.c.sci_Vector.prototype.hashCode__I = (function() {
  return ScalaJS.s.sc_IndexedSeqLike$class__hashCode__sc_IndexedSeqLike__I(this)
});
...
ScalaJS.c.sci_Vector.prototype.init___I__I__I = (function(startIndex, endIndex, focus) {
  ...
  ScalaJS.s.sci_Iterable$class__$$init$__sci_Iterable__V(this);
  ScalaJS.s.sci_Seq$class__$$init$__sci_Seq__V(this);
  ScalaJS.s.sc_IndexedSeqLike$class__$$init$__sc_IndexedSeqLike__V(this);
  ScalaJS.s.sc_IndexedSeq$class__$$init$__sc_IndexedSeq__V(this);
  ScalaJS.s.sci_IndexedSeq$class__$$init$__sci_IndexedSeq__V(this);
  ScalaJS.s.sci_VectorPointer$class__$$init$__sci_VectorPointer__V(this);
  ScalaJS.s.sc_CustomParallelizable$class__$$init$__sc_CustomParallelizable__V(this);
  this.dirty$4 = false;
  return this
});
ScalaJS.is.sci_Vector = (function(obj) {
...
ScalaJS.c.scm_AbstractBuffer.prototype.init___ = (function() {
  ...
  ScalaJS.s.scg_Growable$class__$$init$__scg_Growable__V(this);
  ScalaJS.s.scg_Shrinkable$class__$$init$__scg_Shrinkable__V(this);
  ScalaJS.s.scg_Subtractable$class__$$init$__scg_Subtractable__V(this);
  ScalaJS.s.scm_BufferLike$class__$$init$__scm_Buffer__V(this);
  ScalaJS.s.scm_Buffer$class__$$init$__scm_Buffer__V(this);
  return this
});
...
ScalaJS.c.scm_StringBuilder.prototype.seq__scm_IndexedSeq = (function() {
  return ScalaJS.s.scm_IndexedSeq$class__seq__scm_IndexedSeq__scm_IndexedSeq(this)
});
...
ScalaJS.c.scm_StringBuilder.prototype.iterator__sc_Iterator = (function() {
  return ScalaJS.s.sc_IndexedSeqLike$class__iterator__sc_IndexedSeqLike__sc_Iterator(this)
});
...
ScalaJS.c.scm_StringBuilder.prototype.apply__O__O = (function(v1) {
  return ScalaJS.m.sr_BoxesRunTime$().boxToCharacter__C__jl_Character(this.apply__I__C(ScalaJS.uI(v1)))
});
ScalaJS.c.scm_StringBuilder.prototype.apply__I__O = (function(idx) {
  return ScalaJS.m.sr_BoxesRunTime$().boxToCharacter__C__jl_Character(this.apply__I__C(idx))
});
ScalaJS.c.scm_StringBuilder.prototype.init___jl_StringBuilder = (function(underlying) {
  ...
  ScalaJS.s.sc_IndexedSeqLike$class__$$init$__sc_IndexedSeqLike__V(this);
  ScalaJS.s.sc_IndexedSeq$class__$$init$__sc_IndexedSeq__V(this);
  ScalaJS.s.scm_IndexedSeqLike$class__$$init$__scm_IndexedSeqLike__V(this);
  ScalaJS.s.scm_IndexedSeq$class__$$init$__scm_IndexedSeq__V(this);
  ScalaJS.s.sc_IndexedSeqOptimized$class__$$init$__sc_IndexedSeqOptimized__V(this);
  ScalaJS.s.s_math_Ordered$class__$$init$__s_math_Ordered__V(this);
  ScalaJS.s.sci_StringLike$class__$$init$__sci_StringLike__V(this);
  ScalaJS.s.scg_Growable$class__$$init$__scg_Growable__V(this);
  ScalaJS.s.scm_Builder$class__$$init$__scm_Builder__V(this);
  return this
});
ScalaJS.c.scm_StringBuilder.prototype.init___I__T = (function(initCapacity, initValue) {
  ScalaJS.c.scm_StringBuilder.prototype.init___jl_StringBuilder.call(this, new ScalaJS.c.jl_StringBuilder().init___I(((ScalaJS.m.sjsr_RuntimeString$().length__T__I(initValue) + initCapacity) | 0)).append__T__jl_StringBuilder(initValue));
  return this
});
...
ScalaJS.c.sjs_js_WrappedArray.prototype.init___sjs_js_Array = (function(array) {
  ...
  ScalaJS.s.scm_IndexedSeq$class__$$init$__scm_IndexedSeq__V(this);
  ScalaJS.s.sc_IndexedSeqOptimized$class__$$init$__sc_IndexedSeqOptimized__V(this);
  ScalaJS.s.scm_ArrayLike$class__$$init$__scm_ArrayLike__V(this);
  ScalaJS.s.scm_Builder$class__$$init$__scm_Builder__V(this);
  return this
});
